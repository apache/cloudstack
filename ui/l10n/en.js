...
var dictionary = {
    ...
    "hint.no.tungsten.community":"No Tungsten-Fabric communities found",
    "hint.no.tungsten.protocol":"No Tungsten-Fabric protocols found",
    "hint.type.part.tungsten.protocol":"Type in part of a Tungsten-Fabric protocol",
    "hint.type.part.tungsten.communities":"Type in part of a Tungsten-Fabric community",
    ...
    "label.term.value":"Term Value",
    "label.term.action":"Term Action",
    "label.add.new.term":"Add new term",
    "label.match.all":"Match all",
    ...
    "label.add.tungsten.provider":"Tungsten provider",
    ...
    "label.remove.routing.policy.term":"Remove term",
    ...
    "label.interface.route.tables":"Route tables",
    "label.rule":"Rule",
    ...
    "label.tungsten":"Tungsten Fabric",
    "label.tungsten.applicationpolicyset": "Application Policy Set",
    "label.tungsten.firewallpolicy": "Firewall Policy",
    "label.tungsten.firewallrule": "Firewall Rule",
    "label.tungsten.servicegroup": "Service Group",
    "label.tungsten.addressgroup": "Address Group",
    "label.tungsten.srcaddress": "Source Address",
    "label.tungsten.destaddress": "Destination Address",
    "label.tungsten.srcaddressgroup": "Source Address Group",
    "label.tungsten.destaddressgroup": "Destination Address Group",
    "label.tungsten.firewall.sequence": "Sequence",
    "label.tungsten.logicalrouter": "Logical Router",
    "label.tungsten.nic": "Nic",
    "label.tungsten.direction": "Direction",
    "label.tungsten.ipprefix": "IP Prefix",
    "label.tungsten.ipprefixlen": "Ip Prefix Length",
    "label.tungsten.firewallpolicy.sequence": "Sequence",
    "label.tungsten.policy":"Network Policy",
    "label.tungsten.policy.sequence.major": "Major Sequence",
    "label.tungsten.policy.sequence.minor": "Minor Sequence",
    "label.tungsten.tag":"Tag",
    "label.tungsten.srctag": "Source Tag",
    "label.tungsten.desttag": "Destination Tag",
    "label.tungsten.tagtype": "Tag Type",
    "label.tungsten.tagvalue": "Tag Value",
    "label.tungsten.floatingip": "Floating IP",
    "label.tungsten.rule":"Rule",
    "label.tungsten.rule.action":"Action",
    "label.tungsten.rule.direction": "Direction",
    "label.tungsten.rule.srcnetwork":"Source Network",
    "label.tungsten.rule.srcipprefix":"Source Network Address",
    "label.tungsten.rule.srcipprefixlen":"Source Prefix Length",
    "label.tungsten.rule.srcport":"Source Port",
    "label.tungsten.rule.srcstartport":"Source Start Port",
    "label.tungsten.rule.srcendport":"Source End Port",
    "label.tungsten.rule.destnetwork":"Destination Network",
    "label.tungsten.rule.destipprefix":"Destination Network Address",
    "label.tungsten.rule.destipprefixlen":"Destination Prefix Length",
    "label.tungsten.rule.destport":"Destination Ports",
    "label.tungsten.rule.deststartport":"Destination Start Port",
    "label.tungsten.rule.destendport":"Destination End Port",
    "label.tungsten.rule.protocol":"Protocol",
    "label.tungsten.providers":"Tungsten Fabric Providers",
    "label.tungsten.provider":"Tungsten Fabric Provider",
    "label.tungsten.provider.detail":"Tungsten Fabric Provider Details",
    "label.tungsten.provider.hostname":"Provider hostname",
    "label.tungsten.provider.port":"Provider port",
    "label.tungsten.gateway":"Gateway",
    "label.tungsten.provider.vrouterport":"Provider vrouter port",
    "label.tungsten.provider.introspectport":"Provider introspect port",
    "label.tungsten.network": "Network",
    "label.tungsten.vm": "Instances",
    "label.tungsten.add.applicationpolicyset": "Add Application Policy Set",
    "label.tungsten.add.firewallpolicy": "Add Firewall Policy",
    "label.tungsten.add.firewallrule": "Add Firewall Rule",
    "label.tungsten.add.servicegroup": "Add Service Group",
    "label.tungsten.add.addressgroup": "Add Address Group",
    "label.tungsten.add.provider":"Add Tungsten-Fabric Provider",
    "label.tungsten.add.policy":"Add Policy",
    "label.tungsten.add.rule":"Add Rule",
    "label.tungsten.add.tag":"Add Tag",
    "label.tungsten.add.tagtype":"Add Tag Type",
    "label.tungsten.add.logicalrouter":"Add Logical Router",
    "label.tungsten.add.network.logicalrouter": "Add Logical Router",
    "label.tungsten.delete.applicationpolicyset": "Delete Application Policy Set",
    "label.tungsten.delete.firewallpolicy": "Delete Firewall Policy",
    "label.tungsten.delete.firewallrule": "Delete Firewall Rule",
    "label.tungsten.delete.routing.policy": "Delete Routing Policy",
    "label.tungsten.delete.routing.policy.term": "Delete Routing Policy Term",
    "label.tungsten.delete.servicegroup": "Delete Service Group",
    "label.tungsten.delete.addressgroup": "Delete Address Group",
    "label.tungsten.delete.tag":"Delete Tag",
    "label.tungsten.delete.rule":"Delete Rule",
    "label.tungsten.delete.tagtype":"Delete Tag Type",
    "label.tungsten.delete.policy":"Delete Policy",
    "label.tungsten.delete.logicalrouter":"Delete Logical Router",
    "label.tungsten.action.delete.provider":"Delete provider",
    "label.tungsten.remove.firewallpolicy": "Remove Firewall Policy",
    "label.tungsten.remove.firewallrule": "Remove Firewall Rule",
    "label.tungsten.remove.tag": "Remove Tag",
    "label.tungsten.remove.policy": "Remove Network Policy",
    "label.tungsten.remove.network.logicalrouter": "Remove Logical Router",
    "label.tungsten.apply.firewallpolicy": "Apply Firewall Policy",
    "label.tungsten.apply.firewallrule": "Apply Firewall Rule",
    "label.tungsten.apply.policy": "Apply Network Policy",
    "label.tungsten.apply.tag": "Apply Tag",
    "label.tungsten.routing":"Tungsten Fabric Routing",
    "label.tungsten.add.network.routing.table":"Add Tungsten Fabric network routing table",
    "label.tungsten.add.network.routing.policy":"Add Tungsten Fabric network routing policy",
    "label.tungsten.add.interface.routing.table":"Add Tungsten Fabric interface routing table",
    "label.tungsten.add.route.table.to.network":"Add route table to this network",
    "label.tungsten.add.routing.policy.to.network":"Add routing policy to this network",
    "label.tungsten.add.route.table.to.interface":"Add route table to this instance",
    "label.tungsten.remove.network.routing.table":"Remove Tungsten Fabric network routing table",
    "label.tungsten.remove.interface.routing.table":"Remove Tungsten Fabric interface routing table",
    "label.tungsten.remove.routing.policy":"Remove Tungsten Fabric routing policy",
    "label.tungsten.remove.route.table.from.network":"Remove Tungsten Fabric route table from network",
    "label.tungsten.remove.routing.policy.from.network":"Remove Tungsten Fabric routing policy from network",
    "label.tungsten.remove.route.table.from.interface":"Remove Tunsten Fabric route table from interface",
    "label.tungsten.remove.network.static.route":"Remove Tungsten Fabric network static route",
    "label.tungsten.remove.interface.static.route":"Remove Tungsten Fabric interface static route",
    "label.tungsten.add.network.static.route":"Add Tungsten Fabric network static route",
    "label.tungsten.add.interface.static.route":"Add Tungsten Fabric interface static route",
    "label.tungsten.communities":"Communities",
    "label.tungsten.interface.communities":"Communities",
    "label.tungsten.protocol":"Protocol",
    "label.tungsten.match.all":"Match all communities",
    "label.tungsten.create.routing.policy":"Create routing policy",
    "label.tungsten.add.routing.policy.term":"Add routing policy term",
    "label.routeprefix.list":"Route prefix list",
    "label.tungsten.routing.policy":"Routing Policy",
    "label.routeprefix":"Route prefix",
    "label.routenexthop":"Route next hop",
    "label.routenexthoptype":"Route next hop type",
    "label.static.routes":"Static Routes",
    "label.interface.static.routes":"Interface Static Routes",
    "label.tungsten.network.route.table":"Network Route Table",
    "label.tungsten.network.routing.policy":"Network Routing Policy",
    "label.tungsten.interface.route.table":"Interface Route Table",
    "label.tungsten.route.tables":"Route tables",
    "label.tungsten.routing.policies":"Routing policies",
    "label.vpn":"VPN",
    "label.vpn.customer.gateway":"VPN Customer Gateway",
    ...
    "label.zones":"Zones",
    "label.tungsten.routing.policy":"Routing policy",
    "label.tungsten.routing.policy.terms":"Routing policy terms",
    "label.tungsten.routing.policy.term.name":"Term name",
    "label.tungsten.routing.policy.from.terms":"Routing policy from terms",
    "label.tungsten.routing.policy.then.terms":"Routing policy then terms",
    "label.tungsten.routing.policy.from.term":"Routing policy from term",
    "label.tungsten.routing.policy.then.term":"Routing policy then term",
    "label.tungsten.routing.policy.term.add.community":"Add community",
    "label.tungsten.routing.policy.term.set.community":"Set community",
    "label.tungsten.routing.policy.term.remove.community":"Remove community",
    "label.tungsten.routing.policy.term.local.preference":"Local preferance",
    "label.tungsten.routing.policy.term.med":"Med",
    "label.tungsten.routing.policy.term.action":"Action",
    "label.tungsten.routing.policy.term.as.path":"As path",
    "label.tungsten.add.routing.policy":"Add routing policy",
    "label.installWizard.createRoutingPolicy.title":"Create Tungsten-Fabric routing policy",
    ...
    "message.action.delete.provider":"Please confirm that you want to delete this provider.",
    ...
    "message.add.tungsten.provider.during.zone.creation":"This zone must contain a Tungsten-Fabric provider because the isolation method is TF",
    ...
    "message.add.another.tungsten.routing.policy.term":"Add another Tungsten-Fabric routing policy term",
    "message.add.tungsten.routing.policy.term.then":"Add Tungsten-Fabric routing policy then term",
    "message.add.tungsten.routing.policy.term.from":"Add Tungsten-Fabric routing policy from term",
    ...
    "message.create.tungsten.routing.policy":"Create Tungsten-Fabric routing policy",
    ...
    "message.installWizard.tooltip.addTungstenProvider.name":"A name for the Tungsten-Fabric provider",
    "message.installWizard.tooltip.addTungstenProvider.tungstenproviderhostname":"The hostname of the Tungsten-Fabric provider",
    "message.installWizard.tooltip.addTungstenProvider.tungstenproviderport":"The port of the Tungsten-Fabric provider",
    "message.installWizard.tooltip.addTungstenProvider.tungstenprovidervrouter":"The vrouter of the Tungsten-Fabric provider",
    "message.installWizard.tooltip.addTungstenProvider.tungstenprovidervrouterport":"The vrouter port of the Tungsten-Fabric provider",
    ...
    "message.tooltip.prefix":"Prefix",
    "message.tooltip.prefix.type":"Prefix Type",
    "message.tooltip.community":"Community",
    "message.tooltip.match.all":"Match All",
    "message.tooltip.protocol":"Protocol",
    "message.tooltip.routing.policy.name":"Routing policy name",
    "message.tungsten.routing.policy.delete":"Please confirm that you want to delete Routing Policy",
    "message.tungsten.routing.policy.term.delete":"Please confirm that you want to delete Routing Policy Term",
    "message.tungsten.tag.remove":"Are you sure you want to remove this Tag from this Policy?",
    "message.tungsten.tag.delete":"Please confirm that you want to delete Tag?",
    "message.tungsten.tagtype.delete":"Please confirm that you want to delete Tag Type?",
    "message.tungsten.policy.remove":"Are you sure you want to remove this Policy from this Network?",
    "message.tungsten.policy.delete":"Please confirm that you want to delete Policy?",
    "message.tungsten.rule.delete":"Please confirm that you want to delete Policy Rule?",
    "message.tungsten.firewallpolicy.delete":"Please confirm that you want to delete Firewall Policy?",
    "message.tungsten.firewallrule.delete":"Please confirm that you want to delete Firewall Rule?",
    "message.tungsten.applicationpolicyset.delete":"Please confirm that you want to delete Application Policy Set?",
    "message.tungsten.addressgroup.delete":"Please confirm that you want to delete Address Group?",
    "message.tungsten.servicegroup.delete":"Please confirm that you want to delete Service Group?",
    "message.tungsten.network.route.table.delete":"Please confirm that you want to delete network Route Table",
    "message.tungsten.interface.route.table.delete":"Please confirm that you want to delete interface Route Table",
    "message.tungsten.route.table.remove.from.network":"Please confirm that you want to remove Route Table from this network.",
    "message.tungsten.routing.policy.remove.from.network":"Please confirm that you want to remove Routing Policy from this network",
    "message.tungsten.routing.policy.add.to.network":"Please confirm that you want to add Routing Policy to this network",
    "message.tungsten.route.table.remove.from.interface":"Please confirm that you want to remove Route Table from this nic",
    "message.tungsten.network.static.route.delete":"Please confirm that you want to delete network Static Route",
    "message.tungsten.route.table.add.to.interface":"Please confirm that you want to add Route Table to this nic",
    "message.tungsten.route.table.add.to.network":"Please confirm that you want to add Route Table to this network",
    "message.tungsten.interface.static.route.delete":"Please confirm that you want to delete interface Static Route",
    "message.tungsten.logicalrouter.delete":"Please confirm that you want to delete Logical Router",
    "message.tungsten.logicalrouter.remove":"Please confirm that you want to remove Logical Router",
