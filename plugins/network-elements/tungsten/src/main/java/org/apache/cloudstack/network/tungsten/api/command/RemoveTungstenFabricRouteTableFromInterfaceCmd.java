...
@APICommand(name = RemoveTungstenFabricRouteTableFromInterfaceCmd.APINAME, description = "remove Tungsten-Fabric static route from interface",
        responseObject = SuccessResponse.class, requestHasSensitiveInfo = false,
        responseHasSensitiveInfo = false)
public class RemoveTungstenFabricRouteTableFromInterfaceCmd extends BaseAsyncCmd {
    public static final Logger s_logger = Logger.getLogger(RemoveTungstenFabricRouteTableFromInterfaceCmd.class.getName());
    public static final String APINAME = "removeTungstenFabricRouteTableFromInterface";
    ...
    public String getEventType() {
        return EventTypes.EVENT_TUNGSTEN_REMOVE_ROUTE_TABLE_FROM_INTERFACE;
    }

    @Override
    public String getEventDescription() {
        return "Remove Tungsten-Fabric interface route table from instance";
    }
