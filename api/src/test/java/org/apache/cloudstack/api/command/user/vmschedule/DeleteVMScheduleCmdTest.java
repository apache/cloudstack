...
public class DeleteVMScheduleCmdTest extends TestCase {
    @Mock
    VMScheduleManager vmScheduleManager;

    @InjectMocks
    DeleteVMScheduleCmd cmd = new DeleteVMScheduleCmd();
    ...
    public void testExecute() {
        ...
        Mockito.when(vmScheduleManager.deleteVMSchedule(cmd.getId())).thenReturn(true);
    }
}