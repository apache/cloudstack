 ...
 */
        ...
        public  class ReplaceRouteTableAssociationType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReplaceRouteTableAssociationType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static ReplaceRouteTableAssociationType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReplaceRouteTableAssociationType object =
                new ReplaceRouteTableAssociationType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReplaceRouteTableAssociationType".equals(type)){
                                ...
                                return (ReplaceRouteTableAssociationType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
