...
class TestVPCNetworkHypervisorLimit(cloudstackTestCase):

    @classmethod
    def setUpClass(cls):
        cls.testClient = super(TestVPCNetworkHypervisorLimit, cls).getClsTestClient()
        cls.api_client = cls.testClient.getApiClient()
    ...
    @classmethod
    def tearDownClass(cls):
        super(TestVPCNetworkHypervisorLimit, cls).tearDownClass()

    def tearDown(self):
        super(TestVPCNetworkHypervisorLimit, self).tearDown()
