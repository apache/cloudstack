...
public class NioServer extends NioConnection {
    private final static Logger LOG = LogFactory.getLogger(NioServer.class);
    ...
    protected void init() throws IOException {
        ...
        LOG.info("NioConnection started and listening on " + _serverSocket.socket().getLocalSocketAddress());
    }
    ...
    public void cleanUp() throws IOException {
        ...
        LOG.info("NioConnection stopped on " + _localAddr.toString());
    }
