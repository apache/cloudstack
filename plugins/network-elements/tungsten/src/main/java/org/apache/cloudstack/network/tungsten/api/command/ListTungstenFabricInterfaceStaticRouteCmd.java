...
public class ListTungstenFabricInterfaceStaticRouteCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException, ConcurrentOperationException, ResourceAllocationException, NetworkRuleConflictException {
        ...
        if (zoneId != null) {
            baseResponseList.addAll(tungstenService.listTungstenFabricInterfaceStaticRoute(zoneId, tungstenInterfaceRouteTableUuid, routePrefix));
        } else {
            ...
            for (TungstenProvider tungstenProvider : tungstenProviderVOList) {
                baseResponseList.addAll(tungstenService.listTungstenFabricInterfaceStaticRoute(tungstenProvider.getZoneId(), tungstenInterfaceRouteTableUuid, routePrefix));
            }
        }
