...
public class DeleteNetworkAclEntryType implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DeleteNetworkAclEntryType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DeleteNetworkAclEntryType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        */
        public static DeleteNetworkAclEntryType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DeleteNetworkAclEntryType object = new DeleteNetworkAclEntryType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DeleteNetworkAclEntryType".equals(type)) {
                            ...
                            return (DeleteNetworkAclEntryType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
