...
public class TungstenLogicalRouter implements TungstenModel {
    private LogicalRouter logicalRouter;
    private List<VirtualNetwork> virtualNetworkList;

    public TungstenLogicalRouter() {
    }

    public TungstenLogicalRouter(final LogicalRouter logicalRouter, final List<VirtualNetwork> virtualNetworkList) {
        this.logicalRouter = logicalRouter;
        this.virtualNetworkList = virtualNetworkList;
    }

    public LogicalRouter getLogicalRouter() {
        return logicalRouter;
    }

    public void setLogicalRouter(final LogicalRouter logicalRouter) {
        this.logicalRouter = logicalRouter;
    }
