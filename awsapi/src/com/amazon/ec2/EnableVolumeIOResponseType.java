 ...
 */
        ...
        public  class EnableVolumeIOResponseType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EnableVolumeIOResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static EnableVolumeIOResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnableVolumeIOResponseType object =
                new EnableVolumeIOResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnableVolumeIOResponseType".equals(type)){
                                ...
                                return (EnableVolumeIOResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
