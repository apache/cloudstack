...
public class ListTungstenFabricTagCmd extends BaseListCmd {
    ...
    @Parameter(name = ApiConstants.VM_UUID, type = CommandType.STRING, required = false, description = "the uuid of Tungsten-Fabric vm")
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        List<TungstenFabricTagResponse> tungstenFabricTagResponseList = tungstenService.listTungstenTags(zoneId,
            networkUuid, vmUuid, nicUuid, policyUuid, tagUuid);
        ListResponse<TungstenFabricTagResponse> listResponse = new ListResponse<>();
        listResponse.setResponses(tungstenFabricTagResponseList);
