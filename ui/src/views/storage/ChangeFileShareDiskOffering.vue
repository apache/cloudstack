...
export default {
  ...
  beforeCreate () {
    this.apiParams = this.$getApiParams('changeFileShareDiskOffering')
  },
  created () {
    this.initForm()
    this.fetchData()
  ...
  methods: {
    ...
    handleSubmit (e) {
      ...
      this.formRef.value.validate().then(async () => {
        ...
        this.loading = true
        api('changeFileShareDiskOffering', data).then(response => {
          this.$pollJob({
            jobId: response.changefilesharediskofferingresponse.jobid,
            title: this.$t('label.change.disk.offering'),
            description: values.name,
            successMessage: this.$t('message.success.change.offering'),
            errorMessage: this.$t('message.change.disk.offering.fileshare.failed'),
            loadingMessage: this.$t('message.change.disk.offering.fileshare.processing'),
