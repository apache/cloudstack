 ...
 */
        ...
        public  class EnableVgwRoutePropagationRequestType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EnableVgwRoutePropagationRequestType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static EnableVgwRoutePropagationRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnableVgwRoutePropagationRequestType object =
                new EnableVgwRoutePropagationRequestType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnableVgwRoutePropagationRequestType".equals(type)){
                                ...
                                return (EnableVgwRoutePropagationRequestType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
