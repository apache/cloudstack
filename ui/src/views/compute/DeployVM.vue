                      ...
                      <a-card>
                        <div v-if="this.template && this.template.userdataid">
                          ...
                          <div v-if="templateUserDataParams.length > 0 && !doUserdataOverride">
                            <div v-if="this.template && this.template.userdataid && templateUserDataParams.length > 0">
                        ...
                        <div v-if="this.iso && this.iso.userdataid">
                          ...
                          <br/><br/>
                          <div v-if="templateUserDataParams.length > 0 && !doUserdataOverride">
                            <div v-if="this.iso && this.iso.userdataid && templateUserDataParams.length > 0">
                              Enter the values for the variables in userdata
                            </div>
                            <a-input-group>
                              <a-table
                        ...
                        <div v-if="userdataDefaultOverridePolicy === 'ALLOWOVERRIDE' || userdataDefaultOverridePolicy === 'APPEND' || !userdataDefaultOverridePolicy">
                          <span v-if="userdataDefaultOverridePolicy === 'ALLOWOVERRIDE'" >
                            ...
                            <a-switch @change="val => { doUserdataOverride = val }" :checked="doUserdataOverride" style="margin-left: 10px"/>
                          </span>
                          <span v-if="userdataDefaultOverridePolicy === 'APPEND'">
                            {{ $t('label.userdata.do.append') }}
                            <a-switch @change="val => { doUserdataAppend = val }" :checked="doUserdataAppend" style="margin-left: 10px"/>
                          </span>
                          <a-step
                            :status="zoneSelected ? 'process' : 'wait'">
  ...
  methods: {
    ...
    handleSubmit (e) {
      ...
      this.form.validateFieldsAndScroll(options, async (err, values) => {
        ...
        deployVmData.userdataid = this.userdataid
