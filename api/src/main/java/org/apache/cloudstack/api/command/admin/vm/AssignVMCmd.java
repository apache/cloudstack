...
public class AssignVMCmd extends BaseCmd  {
    ...
    public void execute() {
        try {
            ...
            if (userVm == null) {
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to move Instance");
            }
            ...
            s_logger.error("Failed to move Instance due to: " + e.getStackTrace());
            if (e.getMessage() != null) {
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to move Instance due to " + e.getMessage());
            } else if (e.getCause() != null) {
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to move Instance due to " + e.getCause());
            } else {
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to move Instance");
            }
        }
