                ...
                <a-tooltip placement="right">
                  ...
                  <a-select
                    ...
                    :value="$route.query.filter || (projectView && $route.name === 'vm' ||
                      ['Admin', 'DomainAdmin'].includes($store.getters.userInfo.roletype) && ['vm', 'iso', 'template', 'pod', 'cluster', 'host'].includes($route.name)
                    ...
                    <a-select-option
                      v-if="['Admin', 'DomainAdmin'].includes($store.getters.userInfo.roletype) && ['vm', 'iso', 'template', 'pod', 'cluster', 'host'].includes($route.name)"
                      key="all"
                      :label="$t('label.all')">
                      {{ $t('label.all') }}
                    </a-select-option>
