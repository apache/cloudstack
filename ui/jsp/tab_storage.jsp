    ...
    <div class="grid_container">
        ...
        <div class="grid_header">
			...
			<div class="gridadmin_hostheader_cell0">
			    <div class="grid_headertitles">State Bar</div>
			</div>
			!-->
            <div class="grid_genheader_cell" style="width: 10%;">
                <div class="grid_headertitles">
            ...
            <div class="grid_genheader_cell" style="width: 36%;">
                <div class="grid_headertitles">
                    Name</div>
            </div>
            <div class="grid_genheader_cell" style="width: 10%;">
...
<div id="storage_template" style="display: none">
    ...
    <div id="row_container">
        <!--
		<div class="green_statusbar" id="storage_state_bar"></div>		
		<div class="gridadmin_hostrow_cell4">
			<div class="grid_runningtitles" id="storage_state"></div>
		</div>
		!-->
        <div class="grid_smallgenrow_cell" style="width: 10%;">
        ...
        <div class="grid_smallgenrow_cell" style="width: 36%;">
...
<div class="maincontent" id="submenu_content_volume" style="display: none;">
    ...
    <div class="grid_container">
        ...
        <div class="grid_header">
            ...
            <div class="grid_genheader_cell" id="volume_created_header" style="width: 10%;">
                <div class="grid_headertitles">
                    Created</div>
            </div>
...
<div id="volume_template" style="display: none">
    ...
    <div id="row_container">
        ...
        <div class="grid_smallgenrow_cell" id="volume_created_container" style="width: 10%;">
