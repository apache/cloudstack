    ...
    public void onSSVMAlert(Object sender, SecStorageVmAlertEventArgs args) {
        ...
        switch (args.getType()) {
            ...
            case SecStorageVmAlertEventArgs.SSVM_DOWN:
                ...
                _alertMgr.sendAlert(AlertManager.ALERT_TYPE_SSVM, args.getZoneId(), secStorageVm.getPodIdToDeployIn(), "Secondary Storage Vm down in zone: " +
                                                                                                                       dc.getName() +
                                                                                                                       ", secStorageVm: " +
                                                                                                                       secStorageVm.getHostName() +
                                                                                                                       ", public IP: " +
            ...
            case SecStorageVmAlertEventArgs.SSVM_REBOOTED:
                ...
                _alertMgr.sendAlert(AlertManager.ALERT_TYPE_SSVM, args.getZoneId(), secStorageVm.getPodIdToDeployIn(), "Secondary Storage Vm rebooted in zone: " +
                                                                                                                       dc.getName() +
                                                                                                                       ", secStorageVm: " +
                                                                                                                       secStorageVm.getHostName() +
                                                                                                                       ", public IP: " +
