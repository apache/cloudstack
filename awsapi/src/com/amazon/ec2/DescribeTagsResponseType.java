...
public class DescribeTagsResponseType implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DescribeTagsResponseType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeTagsResponseType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        */
        public static DescribeTagsResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeTagsResponseType object = new DescribeTagsResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeTagsResponseType".equals(type)) {
                            ...
                            return (DescribeTagsResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
