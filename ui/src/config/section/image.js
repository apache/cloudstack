  ...
  children: [
    {
      ...
      details: () => {
        var fields = ['name', 'id', 'displaytext', 'checksum', 'hypervisor', 'architecture', 'format', 'ostypename', 'size', 'physicalsize', 'isready', 'passwordenabled',
    ...
    },
    {
      ...
      details: ['name', 'id', 'displaytext', 'checksum', 'ostypename', 'size', 'architecture', 'bootable', 'isready', 'passwordenabled', 'directdownload', 'isextractable', 'ispublic', 'isfeatured', 'isdynamicallyscalable', 'crosszones', 'account', 'domain', 'created', 'userdatadetails', 'userdatapolicy', 'url'],
      searchFilters: () => {
        var filters = ['name', 'zoneid', 'tags']
        if (['Admin', 'DomainAdmin'].includes(store.getters.userInfo.roletype)) {
          filters.push('storageid')
