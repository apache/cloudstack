...
class TestUserSharedNetworks(cloudstackTestCase):
    ...
    def test_01_create_user_shared_network_without_vlan(self):
        ...
        network1 = self.create_shared_network_for_account(self.admin_apiclient, None, None)
        network2 = self.create_shared_network_for_account(self.domainadmin_apiclient, None, None)
        network3 = self.create_shared_network_for_account(self.normaluser_apiclient, None, None)

        self.delete_network(network1, self.admin_apiclient)
        self.delete_network(network2, self.domainadmin_apiclient)
        self.delete_network(network3, self.normaluser_apiclient)

        network4 = self.create_shared_network_for_account(self.domainadmin_apiclient, self.sub_domain, self.normal_user, True)
        self.delete_network(network4, self.normaluser_apiclient)

        network5 = self.create_shared_network_for_account(self.admin_apiclient, self.sub_domain, None, True)
        self.delete_network(network5, self.admin_apiclient)
        network6 = self.create_shared_network_for_account(self.domainadmin_apiclient, self.sub_domain, None, True)
        self.delete_network(network6, self.admin_apiclient)
    ...
    def test_02_create_shared_network_with_vlan(self):
        ...
        self.create_shared_network_for_account(self.domainadmin_apiclient, self.sub_domain, None, False)
        self.create_shared_network_for_account(self.normaluser_apiclient, self.sub_domain, None, False)
        network1 = self.create_shared_network_for_account(self.admin_apiclient, self.sub_domain, None, True)
        self.create_shared_network_for_account(self.admin_apiclient, self.sub_domain, self.normal_user, False)
        self.delete_network(network1, self.domainadmin_apiclient, False)
        self.delete_network(network1, self.admin_apiclient, True)

        self.create_shared_network_for_account(self.domainadmin_apiclient, self.sub_domain, self.normal_user, False)
        self.create_shared_network_for_account(self.normaluser_apiclient, self.sub_domain, self.normal_user, False)
        network2 = self.create_shared_network_for_account(self.admin_apiclient, self.sub_domain, self.normal_user, True)
        self.delete_network(network2, self.domainadmin_apiclient, False)
        self.delete_network(network2, self.normaluser_apiclient, False)
        self.delete_network(network2, self.admin_apiclient, True)
    ...
    def test_03_create_domain_shared_network_with_associated_network(self):
        ...
        isolated_network1 = self.create_isolated_network_for_account(self.admin_apiclient, None, None, None, True)
        isolated_network2 = self.create_isolated_network_for_account(self.admin_apiclient, self.sub_domain, self.domain_admin, None, True)
        isolated_network3 = self.create_isolated_network_for_account(self.admin_apiclient, self.sub_domain, self.normal_user, None, True)
        isolated_network4 = self.create_isolated_network_for_account(self.admin_apiclient, self.sub_domain, None, self.project, True)

        # Create domain-level shared network with associated_network (caller must be root admin/domain admin, must be in same domain)
        self.create_shared_network_with_associated_network_for_domain(self.admin_apiclient, self.sub_domain, isolated_network1, False)
        self.create_shared_network_with_associated_network_for_domain(self.domainadmin_apiclient, self.sub_domain, isolated_network1, False)
        ...
        shared_network1 = self.create_shared_network_with_associated_network_for_domain(self.admin_apiclient, self.domain, isolated_network1, True)
        shared_network2 = self.create_shared_network_with_associated_network_for_domain(self.domainadmin_apiclient, self.sub_domain, isolated_network2, True)
        shared_network3 = self.create_shared_network_with_associated_network_for_domain(self.domainadmin_apiclient, self.sub_domain, isolated_network3, True)
        shared_network4 = self.create_shared_network_with_associated_network_for_domain(self.domainadmin_apiclient, self.sub_domain, isolated_network4, True)
        ...
        self.delete_network(isolated_network1, self.admin_apiclient, False)
        self.delete_network(isolated_network2, self.admin_apiclient, False)
        self.delete_network(isolated_network3, self.admin_apiclient, False)
        self.delete_network(isolated_network4, self.admin_apiclient, False)
        ...
        self.create_shared_network_with_associated_network_for_domain(self.admin_apiclient, self.sub_domain, vpc1_tier1, False)
        self.create_shared_network_with_associated_network_for_domain(self.domainadmin_apiclient, self.sub_domain, vpc1_tier1, False)
        ...
        shared_network_vpctier1 = self.create_shared_network_with_associated_network_for_domain(self.admin_apiclient, self.domain, vpc1_tier1, True)
        shared_network_vpctier2 = self.create_shared_network_with_associated_network_for_domain(self.domainadmin_apiclient, self.sub_domain, vpc2_tier1, True)
        shared_network_vpctier3 = self.create_shared_network_with_associated_network_for_domain(self.domainadmin_apiclient, self.sub_domain, vpc3_tier1, True)
        shared_network_vpctier4 = self.create_shared_network_with_associated_network_for_domain(self.domainadmin_apiclient, self.sub_domain, vpc4_tier1, True)

        # Check state of vpc tiers (should be Implemented)
        self.check_network_state(self.admin_apiclient, vpc1_tier1, None, NETWORK_STATE_IMPLEMENTED)
        self.check_network_state(self.domainadmin_apiclient, vpc2_tier1, None, NETWORK_STATE_IMPLEMENTED)
        self.check_network_state(self.normaluser_apiclient, vpc3_tier1, None, NETWORK_STATE_IMPLEMENTED)
        self.check_network_state(self.domainadmin_apiclient, vpc4_tier1, self.project, NETWORK_STATE_IMPLEMENTED)

        # Delete vpc tiers(should fail)
        self.delete_network(vpc1_tier1, self.admin_apiclient, False)
        self.delete_network(vpc2_tier1, self.admin_apiclient, False)
        self.delete_network(vpc3_tier1, self.admin_apiclient, False)
        self.delete_network(vpc4_tier1, self.admin_apiclient, False)

        # Delete shared networks associated to domain admin's isolated network or vpc tier(should succeed)
        self.delete_network(shared_network2, self.domainadmin_apiclient, True)
        self.delete_network(shared_network_vpctier2, self.domainadmin_apiclient, True)
        ...
        self.check_network_state(self.admin_apiclient, vpc1_tier1, None, NETWORK_STATE_IMPLEMENTED)
        self.check_network_state(self.domainadmin_apiclient, vpc2_tier1, None, NETWORK_STATE_ALLOCATED)
        self.check_network_state(self.normaluser_apiclient, vpc3_tier1, None, NETWORK_STATE_IMPLEMENTED)
        self.check_network_state(self.domainadmin_apiclient, vpc4_tier1, self.project, NETWORK_STATE_IMPLEMENTED)

        # Check state of shared network (should be Setup)
        self.check_network_state(self.admin_apiclient, shared_network1, None, NETWORK_STATE_SETUP)
        self.check_network_state(self.normaluser_apiclient, shared_network3, None, NETWORK_STATE_SETUP)
        self.check_network_state(self.domainadmin_apiclient, shared_network4, None, NETWORK_STATE_SETUP)

        self.check_network_state(self.admin_apiclient, shared_network_vpctier1, None, NETWORK_STATE_SETUP)
        self.check_network_state(self.normaluser_apiclient, shared_network_vpctier3, None, NETWORK_STATE_SETUP)
        self.check_network_state(self.domainadmin_apiclient, shared_network_vpctier4, None, NETWORK_STATE_SETUP)

        # Delete admin's shared networks (should succeed)
        self.delete_network(shared_network1, self.admin_apiclient, True)
        self.delete_network(shared_network3, self.domainadmin_apiclient, True)
        self.delete_network(shared_network4, self.domainadmin_apiclient, True)

        self.delete_network(shared_network_vpctier1, self.admin_apiclient, True)
        self.delete_network(shared_network_vpctier3, self.domainadmin_apiclient, True)
        self.delete_network(shared_network_vpctier4, self.domainadmin_apiclient, True)
    ...
    def test_04_create_account_shared_network_with_associated_network(self):
        ...
        self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, None, isolated_network1, False)
        self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, None, isolated_network3, False)
        self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, None, isolated_network4, False)
        ...
        shared_network1 = self.create_shared_network_with_associated_network_for_caller(self.admin_apiclient, None, isolated_network1, True)
        shared_network2 = self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, None, isolated_network2, True)
        ...
        shared_network4 = self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, self.project, isolated_network4, True)
        ...
        self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, None, vpc1_tier1, False)
        self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, None, vpc3_tier1, False)
        self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, None, vpc4_tier1, False)
        ...
        shared_network_vpctier1 = self.create_shared_network_with_associated_network_for_caller(self.admin_apiclient, None, vpc1_tier1, True)
        shared_network_vpctier2 = self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, None, vpc2_tier1, True)
        ...
        shared_network_vpctier4 = self.create_shared_network_with_associated_network_for_caller(self.domainadmin_apiclient, self.project, vpc4_tier1, True)
        ...
        self.check_network_state(self.admin_apiclient, shared_network1, None, NETWORK_STATE_SETUP)
        self.check_network_state(self.normaluser_apiclient, shared_network3, None, NETWORK_STATE_SETUP)
        self.check_network_state(self.domainadmin_apiclient, shared_network4, self.project, NETWORK_STATE_SETUP)

        self.check_network_state(self.admin_apiclient, shared_network_vpctier1, None, NETWORK_STATE_SETUP)
        self.check_network_state(self.normaluser_apiclient, shared_network_vpctier3, None, NETWORK_STATE_SETUP)
        self.check_network_state(self.domainadmin_apiclient, shared_network_vpctier4, self.project, NETWORK_STATE_SETUP)
