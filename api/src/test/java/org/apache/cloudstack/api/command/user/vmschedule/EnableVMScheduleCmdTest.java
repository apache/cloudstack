...
public class EnableVMScheduleCmdTest extends TestCase {

    @Mock
    VMScheduleManager vmScheduleManager;

    @InjectMocks
    EnableVMScheduleCmd cmd = new EnableVMScheduleCmd();
    ...
    public void testExecute() {
        ...
        Mockito.when(vmScheduleManager.enableVMSchedule(cmd.getId())).thenReturn(true);
    }
