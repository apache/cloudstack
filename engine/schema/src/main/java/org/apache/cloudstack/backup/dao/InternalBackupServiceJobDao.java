...
public interface InternalBackupServiceJobDao extends GenericDao<InternalBackupServiceJobVO, Long> {

    List<InternalBackupServiceJobVO> listExecutingJobsByZoneIdAndJobType(long zoneId, InternalBackupServiceJobType... jobTypes);
