...
public class CustomerGatewaySetType implements org.apache.axis2.databinding.ADBBean {
    ...
    */
    public void addItem(com.amazon.ec2.CustomerGatewayType param) {
        ...
        list.add(param);
        this.localItem = (com.amazon.ec2.CustomerGatewayType[])list.toArray(new com.amazon.ec2.CustomerGatewayType[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":CustomerGatewaySetType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CustomerGatewaySetType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        */
        public static CustomerGatewaySetType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CustomerGatewaySetType object = new CustomerGatewaySetType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CustomerGatewaySetType".equals(type)) {
                            ...
                            return (CustomerGatewaySetType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "item").equals(reader.getName())) {
                    ...
                    object.setItem((com.amazon.ec2.CustomerGatewayType[])org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                        com.amazon.ec2.CustomerGatewayType.class, list1));
