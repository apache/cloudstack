...
public class XenTest {
    ...
    String VMSLISTXML = results.simpleResponseWrapWrapper("<array><data>\n"
            + "<value><struct>\n"
            + "<member>\n"
    ...
    String VMLISTXML = results.simpleResponseWrapWrapper("<struct>"
            + "<member>"
            + "<name>on_xend_stop</name>"
            + "<value><string>ignore</string></value>"
            + "</member>"
    ...
    String VMCONFIGXML = results.simpleResponseWrapWrapper("<struct>"
            + "<member>"
            + "<name>vif</name>"
            + "<value><array><data>"
            ...
            + "</member>"
            + "<member>"
            + "<name>OVM_simple_name</name>"
            + "<value><string>" + VMNAME + "</string></value>"
            + "</member>"
            + "<member>"
            + "<name>disk</name>"
            + "<value><array><data>"
            + "<value><string>file:/OVS/Repositories/" + REPOID + "/VirtualDisks/" + VMROOTDISK + ",xvda,w</string></value>"
            + "</data></array></value>"
            + "</member>"
            + "<member>"
            + "<name>bootargs</name>"
