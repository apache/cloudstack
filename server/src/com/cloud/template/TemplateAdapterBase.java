...
public abstract class TemplateAdapterBase extends AdapterBase implements TemplateAdapter {
    ...
    public TemplateProfile prepare(RegisterTemplateCmd cmd) throws ResourceAllocationException {
        ...
        return prepare(false, UserContext.current().getCallerUserId(), cmd.getTemplateName(), cmd.getDisplayText(), cmd.getBits(), cmd.isPasswordEnabled(), cmd.getRequiresHvm(),
    ...
    public TemplateProfile prepare(RegisterIsoCmd cmd) throws ResourceAllocationException {
        ...
        return prepare(true, UserContext.current().getCallerUserId(), cmd.getIsoName(), cmd.getDisplayText(), 64, false, true, cmd.getUrl(), cmd.isPublic(), cmd.isFeatured(),
