 ...
 */
        ...
        public  class ModifySnapshotAttributeType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ModifySnapshotAttributeType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static ModifySnapshotAttributeType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ModifySnapshotAttributeType object =
                new ModifySnapshotAttributeType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ModifySnapshotAttributeType".equals(type)){
                                ...
                                return (ModifySnapshotAttributeType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
