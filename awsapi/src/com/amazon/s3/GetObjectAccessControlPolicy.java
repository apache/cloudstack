...
/**
 * GetObjectAccessControlPolicy.java
 *
 ...
 */
            ...
            /**
            *  GetObjectAccessControlPolicy bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetObjectAccessControlPolicy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetObjectAccessControlPolicy",
    ...
    public static class Factory{
        ...
        */
        public static GetObjectAccessControlPolicy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetObjectAccessControlPolicy object =
                new GetObjectAccessControlPolicy();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetObjectAccessControlPolicy".equals(type)){
                                ...
                                return (GetObjectAccessControlPolicy)com.amazon.s3.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
