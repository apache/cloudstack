       ...
       >
        ...
        <div v-else-if="form.provider === 'ECS'">
          ...
          <a-form-item name="url" ref="url">
            <template #label>
              <tooltip-label :title="$t('label.ecs.public.url')" :tooltip="$t('label.ecs.public.url.tooltip')"/>
            </template>
          ...
          <a-form-item name="mgmtUrl" ref="mgmtUrl" :rules="[{ required: true, message: $t('label.required') }]">
            <template #label>
              <tooltip-label :title="$t('label.ecs.api.url')" :tooltip="$t('label.ecs.api.url.tooltip')"/>
            </template>
          ...
          <a-form-item name="s3Host" ref="s3Host" :rules="[{ required: true, message: $t('label.required') }]">
            <template #label>
              <tooltip-label :title="$t('label.ecs.private.url')" :tooltip="$t('label.ecs.private.url.tooltip')"/>
            </template>
          ...
          <a-form-item name="accessKey" ref="accessKey">
            <template #label>
              <tooltip-label :title="$t('label.ecs.sa.user')" :tooltip="$t('label.ecs.sa.user.tooltip')"/>
            </template>
          ...
          <a-form-item name="secretKey" ref="secretKey">
            <template #label>
              <tooltip-label :title="$t('label.ecs.sa.password')" :tooltip="$t('label.ecs.sa.password.tooltip')"/>
            </template>
            <a-input-password v-model:value="form.secretKey" autocomplete="off" />
          </a-form-item>
          ...
          <a-form-item name="namespace" ref="namespace" :rules="[{ required: true, message: $t('label.required') }]">
            <template #label>
              <tooltip-label :title="$t('label.ecs.namespace')" :tooltip="$t('label.ecs.namespace.tooltip')"/>
            </template>
          ...
          <a-form-item name="userPrefix" ref="userPrefix">
            <template #label>
              <tooltip-label :title="$t('label.ecs.user.prefix')" :tooltip="$t('label.ecs.user.prefix.tooltip')"/>
            </template>
    ...
    handleSubmit (e) {
      ...
      this.formRef.value.validate().then(async () => {
        ...
        if (provider === 'Cloudian HyperStore') {
          ...
          data['details[5].value'] = values.userPrefix || 'cs-'
