...
function cleanup_apt() {
  ...
  apt-get -y remove --purge dictionaries-common busybox isc-dhcp-client isc-dhcp-common task-english task-ssh-server tasksel tasksel-data laptop-detect wamerican sharutils \
