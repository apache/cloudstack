...
public class DatabaseUpgradeChecker implements SystemIntegrityChecker {
    ...
    public DatabaseUpgradeChecker() {
        ...
        _upgradeMap.put("2.1.7", new DbUpgrade[] { new Upgrade217to218(), new Upgrade218to22(), new Upgrade221to222(),
                ...
                new Upgrade30to301(), new Upgrade301to302(), new Upgrade302to303(), new Upgrade303to304(), new Upgrade304to305() });
        ...
        _upgradeMap.put("2.1.8", new DbUpgrade[] { new Upgrade218to22(), new Upgrade221to222(), new UpgradeSnapshot217to224(),
                ...
                new Upgrade303to304(), new Upgrade304to305() });
        ...
        _upgradeMap.put("2.2.1", new DbUpgrade[] { new Upgrade221to222(), new UpgradeSnapshot223to224(), new Upgrade222to224(),
                ...
                new Upgrade302to303(), new Upgrade303to304(), new Upgrade304to305() });
        ...
        _upgradeMap.put("2.2.4", new DbUpgrade[] { new Upgrade224to225(), new Upgrade225to226(), new Upgrade227to228(),
                ...
                new Upgrade301to302(), new Upgrade302to303(), new Upgrade303to304(), new Upgrade304to305() });
        ...
        _upgradeMap.put("3.0.3", new DbUpgrade[] { new Upgrade303to304(), new Upgrade304to305() });
        
        _upgradeMap.put("3.0.4", new DbUpgrade[] { new Upgrade304to305() });
