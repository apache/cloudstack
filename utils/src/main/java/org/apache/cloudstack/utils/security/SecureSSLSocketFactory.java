...
public class SecureSSLSocketFactory extends SSLSocketFactory {
    ...
    public static final Logger LOG = LogFactory.getLogger(SecureSSLSocketFactory.class);
    ...
    public String[] getSupportedCipherSuites() {
        ...
        try {
            ...
            LOG.error("SecureSSLSocketFactory::getDefaultCipherSuites found no cipher suites");
        }
        return ciphers;
    }
