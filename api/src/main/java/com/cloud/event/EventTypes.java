...
public class EventTypes {
    ...
    public static final String EVENT_VMSCHEDULE_CREATE = "VM.SCHEDULE.CREATE";
    public static final String EVENT_VMSCHEDULE_DELETE = "VM.SCHEDULE.DELETE";
    public static final String EVENT_VMSCHEDULE_ENABLE = "VM.SCHEDULE.ENABLE";
    public static final String EVENT_VMSCHEDULE_DISABLE = "VM.SCHEDULE.DISABLE";
    public static final String EVENT_VMSCHEDULE_UPDATE = "VM.SCHEDULE.UPDATE";
