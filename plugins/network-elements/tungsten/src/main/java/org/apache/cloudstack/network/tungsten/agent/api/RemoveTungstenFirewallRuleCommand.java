...
public class RemoveTungstenFirewallRuleCommand extends TungstenCommand {
    private final String firewallPolicyUuid;
    private final String firewallRuleUuid;

    public RemoveTungstenFirewallRuleCommand(final String firewallPolicyUuid, final String firewallRuleUuid) {
