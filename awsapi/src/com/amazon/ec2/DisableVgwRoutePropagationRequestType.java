 ...
 */
        ...
        public  class DisableVgwRoutePropagationRequestType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DisableVgwRoutePropagationRequestType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static DisableVgwRoutePropagationRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DisableVgwRoutePropagationRequestType object =
                new DisableVgwRoutePropagationRequestType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DisableVgwRoutePropagationRequestType".equals(type)){
                                ...
                                return (DisableVgwRoutePropagationRequestType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
