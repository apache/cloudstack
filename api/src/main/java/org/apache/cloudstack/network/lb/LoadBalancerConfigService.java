...
public interface LoadBalancerConfigService {
    ...
    List<? extends LoadBalancerConfig> searchForLoadBalancerConfigs(ListLoadBalancerConfigsCmd cmd);

    LoadBalancerConfig createLoadBalancerConfig(CreateLoadBalancerConfigCmd cmd);

    boolean deleteLoadBalancerConfig(DeleteLoadBalancerConfigCmd cmd);

    LoadBalancerConfig updateLoadBalancerConfig(UpdateLoadBalancerConfigCmd cmd);

    List<? extends LoadBalancerConfig> replaceLoadBalancerConfigs(ReplaceLoadBalancerConfigsCmd cmd);
}
