...
(function (cloudStack, $) {
    $.extend(cloudStack, {
        ...
        sections: {
            ...
            accounts: {},
            domains: {},
            //domain-admin and root-admin only
            regions: {},
            //root-admin only
            system: {},
            //root-admin only
    ...
    $(window).bind('cloudStack.pluginReady', function () {
        ...
        var loginArgs = {
            ...
            bypassLoginCheck: function (args) {
                //determine to show or bypass login screen
                ...
                $.ajax({
                    ...
                    error: function (xmlHTTP) {
                        //override default error handling, do nothing instead of showing error "unable to verify user credentials" on login screen
                    },
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        // ignore any errors, fallback to the default
                    }
                });
                // Populate IDP list
                $.ajax({
