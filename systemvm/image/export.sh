...
# Export for VMware
qemu-img convert -f qcow2 -O vmdk -o adapter_type=lsilogic,subformat=streamOptimized,compat6 $PREFIX-kvm.qcow2 $PREFIX-vmware.vmdk
...
rm -f $PREFIX-vmware.ovf $PREFIX-vmware.mf $PREFIX-vmware.vmdk
