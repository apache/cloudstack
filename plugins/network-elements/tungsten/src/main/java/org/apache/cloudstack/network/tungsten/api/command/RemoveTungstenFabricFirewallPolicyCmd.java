...
@APICommand(name = RemoveTungstenFabricFirewallPolicyCmd.APINAME, description = "remove Tungsten-Fabric firewall policy",
...
public class RemoveTungstenFabricFirewallPolicyCmd extends BaseAsyncCmd {
    public static final Logger s_logger = Logger.getLogger(RemoveTungstenFabricFirewallPolicyCmd.class.getName());
    public static final String APINAME = "removeTungstenFabricFirewallPolicy";
    ...
    public String getEventType() {
        return EventTypes.EVENT_TUNGSTEN_REMOVE_FIREWALL_POLICY;
    }

    @Override
    public String getEventDescription() {
        return "remove Tungsten-Fabric firewall policy";
    }
