...
<div class="maincontent" id="submenu_content_events" style="display:none;">
	...
	<div class="grid_container">
		...
		<div class="grid_header"> 
        	<div class="grid_genheader_cell" id="event_initiated_by_header" style="width:13%;">
			...
			<div class="grid_genheader_cell" id="event_type_header" style="width:10%;">			    
				<div class="grid_headertitles" >Type</div>	
				<div class="gridsorting_arrow"></div>			
			</div>
			<div class="grid_genheader_cell" id="event_level_header" style="width:10%;">
				<div class="grid_headertitles">Level</div>
				<div class="gridsorting_arrow"></div>	
			</div>
			<div class="grid_genheader_cell" id="event_description_header" style="width:30%;">
				<div class="grid_headertitles">Description</div>
				<div class="gridsorting_arrow"></div>	
			</div>
			<div class="grid_genheader_cell" id="event_state_header" style="width:10%;">
				<div class="grid_headertitles">State</div>
				<div class="gridsorting_arrow"></div>	
			</div>			
			<div class="grid_genheader_cell" id="event_date_header" style="width:13%;">
...
<div id="event_template" style="display:none">
	<div class="grid_smallgenrow_cell event_initiated_by_row" style="width:13%;">
		<div class="netgrid_celltitles" id="event_username"></div>
	</div>
    <div class="grid_smallgenrow_cell event_account_row" id="event_account_container" style="width:13%;">
		<div class="netgrid_celltitles" id="event_account"></div>
	</div>
	<div class="grid_smallgenrow_cell event_type_row" style="width:10%;">
		<div class="netgrid_celltitles" id="event_type"></div>
	</div>
	<div class="grid_smallgenrow_cell event_level_row" style="width:10%;">
		<div class="netgrid_celltitles" id="event_level"></div>
	</div>
	<div class="grid_smallgenrow_cell event_description_row" style="width:30%;">
		<div class="netgrid_celltitles" id="event_desc"></div>
	</div>
	<div class="grid_smallgenrow_cell event_state_row" style="width:10%;">
		<div class="netgrid_celltitles" id="event_state"></div>
	</div>	
	<div class="grid_smallgenrow_cell event_date_row" style="width:13%;">
...
<div class="maincontent" id="submenu_content_alerts" style="display:none">
	...
	<div class="grid_container">
		...
		<div class="grid_header">
			<div class="grid_genheader_cell" id="alert_type_header" style="width:25%;">
				<div class="grid_headertitles">Type</div>
				<div class="gridsorting_arrow"></div>	
			</div>
			<div class="grid_genheader_cell" id="alert_description_header" style="width:49%;">
				<div class="grid_headertitles">Description</div>
				<div class="gridsorting_arrow"></div>	
			</div>
			<div class="grid_genheader_cell" id="alert_date_header" style="width:25%;">
