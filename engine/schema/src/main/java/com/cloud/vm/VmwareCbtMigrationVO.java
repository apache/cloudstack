...
public class VmwareCbtMigrationVO implements VmwareCbtMigration {
    ...
    @Column(name = "data_disk_offering_map")
    private String dataDiskOfferingMap;

    @Column(name = "nic_network_map")
    private String nicNetworkMap;

    @Column(name = "nic_ip_address_map")
    private String nicIpAddressMap;

    @Column(name = "import_details")
    ...
    public String getDataDiskOfferingMap() {
        return dataDiskOfferingMap;
    }

    public void setDataDiskOfferingMap(String dataDiskOfferingMap) {
        this.dataDiskOfferingMap = dataDiskOfferingMap;
    }
    ...
    public String getNicIpAddressMap() {
        return nicIpAddressMap;
    }

    public void setNicIpAddressMap(String nicIpAddressMap) {
        this.nicIpAddressMap = nicIpAddressMap;
    }
