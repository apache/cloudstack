...
public class CreateVPCCmd extends BaseAsyncCreateCmd {
    ...
    public void create() throws ResourceAllocationException {
        Vpc vpc=null;
        try {
            vpc = _vpcService.createVpc(getZoneId(), getVpcOffering(), getEntityOwnerId(), getVpcName(), getDisplayText(), getCidr(), getNetmask(), getNetworkDomain(),
                    getDisplayVpc());
        } catch (CIDRException e) {
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to create the VPC, BAD CIDR " + getNetmask());
        }
        if (vpc != null) {
