...
public class ListTungstenFabricPolicyRuleCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        List<TungstenFabricRuleResponse> tungstenFabricRuleResponseList = tungstenService.listTungstenPolicyRule(
            zoneId, policyUuid, ruleUuid);
        ListResponse<TungstenFabricRuleResponse> listResponse = new ListResponse<>();
        listResponse.setResponses(tungstenFabricRuleResponseList);
