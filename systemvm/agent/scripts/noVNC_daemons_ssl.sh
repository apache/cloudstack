...
python /root/noVNC/utils/websockify/websockify/websocketproxy.py --ssl-only --web=/root/noVNC --log-file=/var/log/novnc.log --daemon --cert=/usr/local/cloud/systemvm/certs/customssl.crt --key=/usr/local/cloud/systemvm/certs/customssl.key 8080
