...
/**
*  TopicConfiguration bean class
*/

public class TopicConfiguration implements org.apache.axis2.databinding.ADBBean {
    ...
    */
     ...
     */
    protected void validateEvent(java.lang.String[] param) {
    ...
    */
    public void addEvent(java.lang.String param) {
        if (localEvent == null) {
            localEvent = new java.lang.String[] {};
        }

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localEvent);
        list.add(param);
        this.localEvent = (java.lang.String[])list.toArray(new java.lang.String[list.size()]);
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                TopicConfiguration.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    */
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        elementList.add(new javax.xml.namespace.QName("http://s3.amazonaws.com/doc/2006-03-01/", "Topic"));
        ...
        if (localEvent != null) {
            for (int i = 0; i < localEvent.length; i++) {
                ...
                if (localEvent[i] != null) {
                    elementList.add(new javax.xml.namespace.QName("http://s3.amazonaws.com/doc/2006-03-01/", "Event"));
                    elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localEvent[i]));
                } else {
    ...
    public static class Factory {
        ...
        */
        public static TopicConfiguration parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
