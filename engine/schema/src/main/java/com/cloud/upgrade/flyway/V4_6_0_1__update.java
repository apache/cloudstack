...
import com.cloud.upgrade.dao.DbUpgradeUtils;
import com.cloud.utils.exception.CloudRuntimeException;

public class V4_6_0_1__update extends BaseJavaMigration {
    final static Logger s_logger = Logger.getLogger(V4_6_0_1__update.class);
