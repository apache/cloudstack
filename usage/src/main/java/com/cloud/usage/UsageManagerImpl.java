...
public class UsageManagerImpl extends ManagerBase implements UsageManager, Runnable {
    ...
    private void createVolumeHelperEvent(UsageEventVO event) {
        ...
        case EventTypes.EVENT_VOLUME_CREATE:
            ...
            s_logger.debug(String.format("Creating a new entry in usage_volume for volume with id: {} for account: {}", volId, event.getVmId(), event.getAccountId()));
        ...
        case EventTypes.EVENT_VOLUME_RESIZE:
            ...
            for (UsageVolumeVO volumesVO : volumesVOs) {
                ...
                s_logger.debug(delete_msg);
                volumesVO.setDeleted(event.getCreateDate());
                _usageVolumeDao.update(volumesVO.getId(), volumesVO);

                s_logger.debug(create_msg);
        ...
        case EventTypes.EVENT_VOLUME_ATTACH:
            ...
            s_logger.debug(String.format("Creating a new entry in usage_volume for volume with id: {}, and instance id: {} for account: {}",
        ...
        case EventTypes.EVENT_VOLUME_UPLOAD:
            ...
            s_logger.debug(String.format("Creating a new entry in usage_storage for volume with id : {} for account: {}", volId, event.getAccountId()));
