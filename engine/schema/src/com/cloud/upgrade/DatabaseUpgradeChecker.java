...
import com.cloud.upgrade.dao.Upgrade411to420;
...
public class DatabaseUpgradeChecker implements SystemIntegrityChecker {
    ...
    public DatabaseUpgradeChecker() {
        ...
        _upgradeMap.put("2.1.7", new DbUpgrade[] { new Upgrade217to218(), new Upgrade218to22(), new Upgrade221to222(),
                ...
                new Upgrade410to411(), new Upgrade411to420() });
        ...
        _upgradeMap.put("4.1.0", new DbUpgrade[] { new Upgrade410to411(), new Upgrade411to420() });

        _upgradeMap.put("4.1.1", new DbUpgrade[] { new Upgrade411to420() });
