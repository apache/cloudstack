 ...
 */
        ...
        public  class EnableVolumeIOType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EnableVolumeIOType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EnableVolumeIOType",
    ...
    public static class Factory{
        ...
        */
        public static EnableVolumeIOType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnableVolumeIOType object =
                new EnableVolumeIOType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnableVolumeIOType".equals(type)){
                                ...
                                return (EnableVolumeIOType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
