...
public class CreateResourceAlertRuleCmd extends BaseCmd {
    ...
    @Parameter(name = ApiConstants.METRIC, type = CommandType.STRING, required = true,
            description = "metric to monitor (e.g. CPU_UTILIZATION, MEMORY_UTILIZATION)")
    private String metric;

    @Parameter(name = ApiConstants.CONDITION, type = CommandType.STRING, required = true,
            description = "comparison operator: GT, GTE, LT, LTE, EQ")
    private String condition;

    @Parameter(name = ApiConstants.THRESHOLD, type = CommandType.DOUBLE, required = true,
            description = "threshold value that triggers the alert")
    private Double threshold;

    @Parameter(name = ApiConstants.SEVERITY, type = CommandType.STRING, required = true,
