...
class ConsoleCanvas2 extends ConsoleCanvas {

  public ConsoleCanvas2(ConsoleViewer v) throws IOException {
    super(v);
    disableFocusTraversalKeys();
  }

  public ConsoleCanvas2(ConsoleViewer v, int maxWidth_, int maxHeight_)
    {
