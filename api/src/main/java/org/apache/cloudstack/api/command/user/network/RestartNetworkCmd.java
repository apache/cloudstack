...
public class RestartNetworkCmd extends BaseAsyncCmd {
    ...
    @Parameter(name = ApiConstants.LIVE_PATCH, type = CommandType.BOOLEAN, required = false, description = "Live Patch the router before restarting it. This parameter will work only when 'cleanup' is false.", since = "4.16.1")
