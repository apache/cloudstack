...
/**
*  LicenseSetItemType bean class
*/

public class LicenseSetItemType implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
            name = LicenseSetItemType
    ...
    */
    ...
    protected java.lang.String localPool;
    ...
    */
    ...
    /**
       ...
       * @param param Pool
       */
    public void setPool(java.lang.String param) {
    ...
    /**
    * field for CapacitySet
    */

    protected com.amazon.ec2.LicenseCapacitySetType localCapacitySet;

    /**
    * Auto generated getter method
    * @return com.amazon.ec2.LicenseCapacitySetType
    */
    public com.amazon.ec2.LicenseCapacitySetType getCapacitySet() {
        return localCapacitySet;
    }

    /**
       * Auto generated setter method
       * @param param CapacitySet
       */
    public void setCapacitySet(com.amazon.ec2.LicenseCapacitySetType param) {

        this.localCapacitySet = param;
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                LicenseSetItemType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":LicenseSetItemType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "LicenseSetItemType", xmlWriter);
            }
        ...
        if (!namespace.equals("")) {
            ...
            if (prefix == null) {
                ...
                xmlWriter.writeStartElement(prefix, "pool", namespace);
                xmlWriter.writeNamespace(prefix, namespace);
                xmlWriter.setPrefix(prefix, namespace);

            } else {
                xmlWriter.writeStartElement(namespace, "pool");
            }

        } else {
            xmlWriter.writeStartElement("pool");
        }
        ...
        if (localPool == null) {
            ...
            xmlWriter.writeCharacters(localPool);
        ...
        localCapacitySet.serialize(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "capacitySet"), factory, xmlWriter);
    ...
    */
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "pool"));
        ...
        elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "capacitySet"));
    ...
    public static class Factory {
        ...
        */
        public static LicenseSetItemType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LicenseSetItemType object = new LicenseSetItemType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"LicenseSetItemType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (LicenseSetItemType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "pool").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setPool(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "capacitySet").equals(reader.getName())) {

                    object.setCapacitySet(com.amazon.ec2.LicenseCapacitySetType.Factory.parse(reader));
