...
public class GetTungstenSecurityGroupCommand extends TungstenCommand {
    private final String tungstenSecurityGroupUuid;

    public GetTungstenSecurityGroupCommand(String tungstenSecurityGroupUuid) {
    ...
    public boolean equals(Object o) {
        ...
        GetTungstenSecurityGroupCommand that = (GetTungstenSecurityGroupCommand) o;
