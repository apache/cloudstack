...
ALTER TABLE `cloud`.`vm_template` ADD COLUMN `enable_agent` int(1) unsigned NOT NULL DEFAULT '0' COMMENT 'true if this template supports qemu guest agent';
