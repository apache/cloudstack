...
public class DeleteNetrisACLCommandTest {
    ...
    private static final List<String> ACL_RULE_NAMES = Arrays.asList("rule1", "rule2");

    @Test
    public void testConstructorAndGetters() {
        // Act
        DeleteNetrisACLCommand command = new DeleteNetrisACLCommand(
                ZONE_ID, ACCOUNT_ID, DOMAIN_ID, NAME, ID, IS_VPC, VPC_ID, VPC_NAME);
    ...
    public void testSettersAndGetters() {
        ...
        // Act
        command.setAclRuleNames(ACL_RULE_NAMES);

        // Assert
        assertEquals(ACL_RULE_NAMES, command.getAclRuleNames());
    }
    ...
    public void testConstructorWithEmptyStrings() {
        // Act
        DeleteNetrisACLCommand command = new DeleteNetrisACLCommand(
                ZONE_ID, ACCOUNT_ID, DOMAIN_ID, "", ID, IS_VPC, VPC_ID, "");
    ...
    public void testConstructorWithNullValues() {
        // Act
        DeleteNetrisACLCommand command = new DeleteNetrisACLCommand(
                ZONE_ID, null, null, NAME, null, IS_VPC, null, VPC_NAME);
