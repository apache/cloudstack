                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InstancePrivateIpAddressesSetItemType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static InstancePrivateIpAddressesSetItemType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InstancePrivateIpAddressesSetItemType object =
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InstancePrivateIpAddressesSetItemType".equals(type)){
                                ...
                                return (InstancePrivateIpAddressesSetItemType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
