...
export default {
  ...
  details: ['name', 'id', 'resourcestate', 'ipaddress', 'hypervisor', 'externalprovisioner', 'arch', 'type', 'clustername', 'podname', 'zonename', 'managementservername', 'disconnected', 'created', 'details'],
  tabs: [{
    name: 'details',
