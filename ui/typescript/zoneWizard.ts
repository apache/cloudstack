        ...
        preFilters: {
            ...
            addPublicNetwork: function (args) {
                ...
                if (args.data['network-model'] == 'Basic') {
                    ...
                    //args.data['network-model'] == 'Advanced'
        ...
        forms: {
            ...
            guestTraffic: {
                ...
                fields: {
                    ...
                    vlanRange: {
                        //in multiple tabs (tabs is as many as Guest Traffic types in multiple physical networks in Advanced Zone without SG)
        ...
        action: function (args) {
            ...
            var stepFns = {
                ...
                addGuestNetwork: function (args) {
                    //create a guest network for Basic zone or Advanced zone with SG
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (json) {
                                            stepFns.addPrimaryStorage({
                                                //skip "add host step" when hypervisor is VMware
                                                data: $.extend(args.data, {
