...
public class NsxGuestNetworkGuruTest {
    ...
    public void setUp() throws IllegalAccessException, NoSuchFieldException {
        ...
        when(offering.getNetworkMode()).thenReturn(NetworkOffering.NetworkMode.NATTED.name());
    ...
    public void testCreateNsxSegmentForIsolatedNetwork() {
        ...
        when(offeringVO.getNetworkMode()).thenReturn(NetworkOffering.NetworkMode.NATTED.name());
        guru.createNsxSegment(networkVO, dataCenter);
