 ...
 */
        ...
        public  class RevokeSecurityGroupEgressResponseType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RevokeSecurityGroupEgressResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static RevokeSecurityGroupEgressResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RevokeSecurityGroupEgressResponseType object =
                new RevokeSecurityGroupEgressResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RevokeSecurityGroupEgressResponseType".equals(type)){
                                ...
                                return (RevokeSecurityGroupEgressResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
