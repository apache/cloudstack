...
class ConsoleCanvas extends Canvas
  ...
  //Sheng: Moved to VncViewer.java
    ...
    /*
Logger.log(Logger.INFO, "Set size to 800x600 3");
memImage = viewer.vncContainer.createImage(800, 600);
memGraphics = memImage.getGraphics();
    setSize(800,600);
    */
//    setPixelFormat(); //Sheng: Moved to VncViewer
  ...
  public void update(Graphics g) {
    ...
    public void paint(Graphics g) {
		// Logger.log(Logger.INFO, "VncCanvas.paint called g=" + g.hashCode() + g +
		// " memImage=" + memImage);
		if (rfb == null) {
			return;
		}
...
if (!viewer.inProxyMode) {
  ...
  void writeToClientStream(byte[] bs) {
...
//      if (viewer.inProxyMode) {
//    	  Logger.log(Logger.DEBUG, "bs != null = " + (bs != null) + " viewer.clientStream = " + viewer.clientStream + " info = " + viewer.clientStreamInfo);
//      }
...
/*
			...
			if (timestamp != 0 && interval > 50) { // Anything taking less than 50ms is too small a packet
				long rate = bytes_sent_last * 1000 / interval;
				Logger.log(Logger.DEBUG, "Rate = " + rate + "bytes/sec");
				if (rate > rate_limit) {
					long wait_time = bytes_sent_last * 1000 / rate_limit - interval;
					try {
						Logger.log(Logger.DEBUG, "Waiting for " + wait_time + "ms in order to throttle bandwidth");
...
//	  Logger.log(Logger.INFO, "RFB Update Rect Encoding: " + rfb.updateRectEncoding);
...
//	viewer.clipboard.setCutText(s);
  ...
  void handleRawRect(int x, int y, int w, int h, boolean paint)
      throws IOException {
//Logger.log(Logger.INFO, "handleRawRect " + " x=" + x + " y=" + y + " w=" + w + " h=" + h + " paint=" + paint);
...
//Logger.log(Logger.INFO, "handleCopyRect " + " x=" + x + " y=" + y + " w=" + w + " h=" + h);
    rfb.readCopyRect();
  ...
  //Logger.log(Logger.INFO, "handleRRERect " + " x=" + x + " y=" + y + " w=" + w + " h=" + h);
  ...
  //Logger.log(Logger.INFO, "handleCpRRERect " + " x=" + x + " y=" + y + " w=" + w + " h=" + h);
    int nSubrects = rfb.is.readInt();
...
//Logger.log(Logger.INFO, "handleHextileRect " + " x=" + x + " y=" + y + " w=" + w + " h=" + h);
...
//Logger.log(Logger.INFO, "handleZRLERect " + " x=" + x + " y=" + y + " w=" + w + " h=" + h);
    ...
    if (rfb.rec != null) {
      if (rfb.recordFromBeginning) {
        ...
        Logger.log(Logger.INFO, "Warning: ZRLE session can be recorded" +
...
//Logger.log(Logger.INFO, "handleZlibRect " + " x=" + x + " y=" + y + " w=" + w + " h=" + h);
    int nBytes = rfb.is.readInt();
...
//Logger.log(Logger.INFO, "handleTightRect " + " x=" + x + " y=" + y + " w=" + w + " h=" + h);
...
//	  Logger.log(Logger.INFO, "handleUpdatedPixels x=" + x + " y=" + y + " w=" + w + " h=" + h + " memGraphics=" + memGraphics.hashCode() + memGraphics + " rawPixselsImage=" + rawPixelsImage);
...
//  Logger.log(Logger.INFO, "scheduleRepaint " + " x=" + x + " y=" + y + " w=" + w + " h=" + h);
