...
public class QuaggaRule extends ConfigBase {
    String[] zebraConfig;
    String[] ospfConfig;
    String tmpCfgFilePath;
    String tmpCfgFileName;
    String routerIp;
    ...
    public QuaggaRule(String[] zebraConfig, String[] ospfConfig, String tmpCfgFilePath, String tmpCfgFileName, String routerIp) {
        super(QuaggaRule.QUAGGA);
