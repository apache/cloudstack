...
public class EventTypes {
    ...
    // Tungsten-Fabric
    public static final String EVENT_TUNGSTEN_ADD_FIREWALL_POLICY = "TUNGSTEN.ADD.FIREWALL.POLICY";
    public static final String EVENT_TUNGSTEN_ADD_FIREWALL_RULE = "TUNGSTEN.ADD.FIREWALL.RULE";
    ...
    public static final String EVENT_TUNGSTEN_REMOVE_FIREWALL_POLICY = "TUNGSTEN.REMOVE.FIREWALL.POLICY";
    public static final String EVENT_TUNGSTEN_REMOVE_FIREWALL_RULE = "TUNGSTEN.REMOVE.FIREWALL.RULE";
    ...
    public static final String EVENT_TUNGSTEN_CREATE_ROUTE_TABLE = "TUNGSTEN.CREATE.ROUTE.TABLE";
    public static final String EVENT_TUNGSTEN_ADD_STATIC_ROUTE = "TUNGSTEN.ADD.STATIC.ROUTE";
    public static final String EVENT_TUNGSTEN_REMOVE_STATIC_ROUTE = "TUNGSTEN.REMOVE.STATIC.ROUTE";
    public static final String EVENT_TUNGSTEN_REMOVE_ROUTE_TABLE = "TUNGSTEN.REMOVE.ROUTE.TABLE";
    public static final String EVENT_TUNGSTEN_ADD_ROUTE_TABLE_TO_NETWORK = "TUNGSTEN.ADD.ROUTE.TO.NETWORK";
    public static final String EVENT_TUNGSTEN_ADD_ROUTE_TABLE_TO_INTERFACE = "TUNGSTEN.ADD.ROUTE.TO.INTERFACE";
    public static final String EVENT_TUNGSTEN_REMOVE_ROUTE_TABLE_FROM_NETWORK = "TUNGSTEN.RM.ROUTE.FROM.NET";
    public static final String EVENT_TUNGSTEN_REMOVE_ROUTE_TABLE_FROM_INTERFACE = "TUNGSTEN.RM.ROUTE.FROM.INTF";
    ...
    public static final String EVENT_TUNGSTEN_REMOVE_NETWORK_GATEWAY_FROM_LOGICAL_ROUTER = "TUNGSTEN.REMOVE.NETWORK.GW.FROM.LG";
    public static final String EVENT_TUNGSTEN_DELETE_LOGICAL_ROUTER = "TUNGSTEN.DELETE.LOGICAL.ROUTER";
    public static final String EVENT_TUNGSTEN_CREATE_ROUTING_POLICY = "TUNGSTEN.CREATE.ROUTING.POLICY";
    public static final String EVENT_TUNGSTEN_ADD_ROUTING_POLICY_TERM = "TUNGSTEN.ADD.POLICY.TERM";
    public static final String EVENT_TUNGSTEN_REMOVE_ROUTING_POLICY = "TUNGSTEN.RM.ROUTING.POLICY";
