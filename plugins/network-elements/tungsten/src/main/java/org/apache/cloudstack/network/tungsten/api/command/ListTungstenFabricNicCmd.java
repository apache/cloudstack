...
public class ListTungstenFabricNicCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        List<TungstenFabricNicResponse> tungstenFabricNicResponseList = tungstenService.listTungstenNic(zoneId,
            nicUuid);
        ListResponse<TungstenFabricNicResponse> listResponse = new ListResponse<>();
        listResponse.setResponses(tungstenFabricNicResponseList);
