...
@APICommand(name = "deleteNativeBackupOffering", description = "Deletes a native backup offering", responseObject = NativeBackupOfferingResponse.class,
        requestHasSensitiveInfo = false, responseHasSensitiveInfo = false, authorized = {RoleType.Admin}, since = "4.23.0")
public class DeleteNativeBackupOfferingCmd extends BaseCmd {
    @Inject
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException, ConcurrentOperationException, ResourceAllocationException,
        ...
        NativeBackupOffering offering = nativeBackupOfferingService.deleteNativeBackupOffering(this);
