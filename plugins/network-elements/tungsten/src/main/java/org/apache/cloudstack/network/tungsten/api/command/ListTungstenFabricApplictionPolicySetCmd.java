...
public class ListTungstenFabricApplictionPolicySetCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        List<TungstenFabricApplicationPolicySetResponse> tungstenFabricApplicationPolicySetResponseList =
            tungstenService
            .listTungstenApplicationPolicySet(zoneId, applicationPolicySetUuid);
        ListResponse<TungstenFabricApplicationPolicySetResponse> listResponse = new ListResponse<>();
        listResponse.setResponses(tungstenFabricApplicationPolicySetResponseList);
