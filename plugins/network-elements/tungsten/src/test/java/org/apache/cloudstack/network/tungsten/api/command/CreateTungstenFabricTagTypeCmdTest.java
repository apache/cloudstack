...
public class CreateTungstenFabricTagTypeCmdTest {
    ...
    public void executeTest() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        TungstenFabricTagTypeResponse tungstenFabricTagTypeResponse = Mockito.mock(TungstenFabricTagTypeResponse.class);
        Mockito.when(tungstenService.createTungstenTagType(ArgumentMatchers.anyLong(), ArgumentMatchers.anyString())).thenReturn(tungstenFabricTagTypeResponse);
        createTungstenFabricTagTypeCmd.execute();
        Assert.assertEquals(tungstenFabricTagTypeResponse, createTungstenFabricTagTypeCmd.getResponseObject());
    }
}
