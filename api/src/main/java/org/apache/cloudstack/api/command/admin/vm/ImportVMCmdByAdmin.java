...
@APICommand(name = ImportVMCmdByAdmin.APINAME,
        description = "Imports an un-managed external VM to CloudStack",
        responseObject = SuccessResponse.class,
        since = "4.14.0",
        authorized = {RoleType.Admin})
public class ImportVMCmdByAdmin extends BaseAsyncCmd {
    public static final String APINAME = "importVirtualMachine";
    ...
    @Parameter(name = ApiConstants.NAME,
            ...
            required = true,
            description = "The internal VM name as on the hypervisor")
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException, ConcurrentOperationException, ResourceAllocationException, NetworkRuleConflictException {
        ...
        boolean result = backupManager.importVM(zoneId, domainId, accountId, userId, vmInternalName, Hypervisor.HypervisorType.VMware, null);
        if (result) {
