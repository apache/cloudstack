                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.amazon.s3.ListAllMyBucketsEntry[] getBucket(){
                             ...
                             * @param param com.amazon.s3.ListAllMyBucketsEntry
                             */
                             public void addBucket(com.amazon.s3.ListAllMyBucketsEntry param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localBucket);
                               list.add(param);
                               this.localBucket =
                             (com.amazon.s3.ListAllMyBucketsEntry[])list.toArray(
                            new com.amazon.s3.ListAllMyBucketsEntry[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ListAllMyBucketsList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                       ...
                                       if (localBucket!=null){
                                            for (int i = 0;i < localBucket.length;i++){
                                                if (localBucket[i] != null){
                                                 localBucket[i].serialize(new javax.xml.namespace.QName("http://s3.amazonaws.com/doc/2006-03-01/","Bucket"),
                                                           factory,xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static ListAllMyBucketsList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListAllMyBucketsList object =
                new ListAllMyBucketsList();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ListAllMyBucketsList".equals(type)){
                                ...
                                return (ListAllMyBucketsList)com.amazon.s3.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(com.amazon.s3.ListAllMyBucketsEntry.Factory.parse(reader));
                                                        ...
                                                        object.setBucket((com.amazon.s3.ListAllMyBucketsEntry[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.amazon.s3.ListAllMyBucketsEntry.class,
                                                                list1));
