...
CREATE TABLE IF NOT EXISTS `cloud`.`op_host_upgrade` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`op_lock` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`op_ha_work` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`sequence` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`volumes` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`snapshots` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`vlan` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`pod_vlan_map` (
  `id` bigint unsigned NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cloud`.`op_dc_ip_address_alloc` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'primary key',
...
CREATE TABLE IF NOT EXISTS `cloud`.`op_dc_vnet_alloc` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`load_balancer_vm_map` (
  `id` bigint unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `cloud`.`host_details` (
  `id` bigint unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `cloud`.`user_vm` (
  `id` bigint unsigned UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cloud`.`domain_router` (
...
CREATE TABLE IF NOT EXISTS `cloud`.`resource_limit` (
  `id` bigint unsigned NOT NULL auto_increment,
  `domain_id` bigint unsigned,
...
CREATE TABLE IF NOT EXISTS `cloud`.`resource_count` (
  `id` bigint unsigned NOT NULL auto_increment,
  `account_id` bigint unsigned,
  `domain_id` bigint unsigned,
  `type` varchar(255),
...
CREATE TABLE IF NOT EXISTS `cloud`.`op_host_capacity` (
  `id` bigint unsigned NOT NULL auto_increment,
  `host_id` bigint unsigned,
  `data_center_id` bigint unsigned NOT NULL,
  `pod_id` bigint unsigned,
...
CREATE TABLE IF NOT EXISTS `cloud`.`alert` (
  `id` bigint unsigned NOT NULL auto_increment,
  `uuid` varchar(40),
  `type` int(1) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cloud`.`async_job` (
  `id` bigint unsigned NOT NULL auto_increment,
  `user_id` bigint unsigned NOT NULL,
  `account_id` bigint unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cloud`.`sync_queue` (
  `id` bigint unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `cloud`.`stack_maid` (
  `id` bigint unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `cloud`.`sync_queue_item` (
  `id` bigint unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `cloud`.`disk_offering` (
  `id` bigint unsigned NOT NULL auto_increment,
  `domain_id` bigint unsigned,
  `name` varchar(255) NOT NULL,
  `uuid` varchar(40),
...
CREATE TABLE IF NOT EXISTS `cloud`.`network_rule_config` (
  `id` bigint unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `cloud`.`guest_os` (
  `id` bigint unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `cloud`.`guest_os_category` (
  `id` bigint unsigned NOT NULL auto_increment,
  `name` varchar(255) NOT NULL,
  `uuid` varchar(40),
  PRIMARY KEY  (`id`),
...
CREATE TABLE IF NOT EXISTS `cloud`.`snapshot_policy` (
  `id` bigint unsigned NOT NULL auto_increment,
  `uuid` varchar(40),
  `volume_id` bigint unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cloud`.`op_pod_vlan_alloc` (
    `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'primary id',
...
CREATE TABLE IF NOT EXISTS `cloud`.`security_group` (
  `id` bigint unsigned NOT NULL auto_increment,
  `name` varchar(255) NOT NULL,
  `uuid` varchar(40),
...
CREATE TABLE IF NOT EXISTS `cloud`.`security_group_rule` (
  `id` bigint unsigned NOT NULL auto_increment,
  `uuid` varchar(40),
  `security_group_id` bigint unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cloud`.`security_group_vm_map` (
  `id` bigint unsigned NOT NULL auto_increment,
  `security_group_id` bigint unsigned NOT NULL,
  `instance_id` bigint unsigned NOT NULL,
  PRIMARY KEY  (`id`),
