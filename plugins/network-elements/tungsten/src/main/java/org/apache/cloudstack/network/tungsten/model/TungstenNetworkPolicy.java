...
public class TungstenNetworkPolicy implements TungstenModel {
    private NetworkPolicy networkPolicy;
    private List<VirtualNetwork> virtualNetworkList;

    public TungstenNetworkPolicy() {
    }

    public TungstenNetworkPolicy(final NetworkPolicy networkPolicy, final List<VirtualNetwork> virtualNetworkList) {
    ...
    public void setNetworkPolicy(final NetworkPolicy networkPolicy) {
        this.networkPolicy = networkPolicy;
    }
