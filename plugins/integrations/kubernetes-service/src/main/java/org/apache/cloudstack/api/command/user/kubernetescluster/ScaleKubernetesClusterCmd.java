...
public class ScaleKubernetesClusterCmd extends BaseAsyncCmd {
    ...
    public String getEventDescription() {
        return "Scaling Kubernetes cluster id: " + getId();
    }
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException, ConcurrentOperationException, ResourceAllocationException, NetworkRuleConflictException {
        ...
        try {
            ...
            LOGGER.warn("Failed to scale Kubernetes cluster:" + kubernetesCluster.getUuid() + " due to " + ex.getMessage());
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR,
                    "Failed to scale Kubernetes cluster:" + kubernetesCluster.getUuid(), ex);
        }
    }
}
