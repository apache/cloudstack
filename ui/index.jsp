...
'message.action.disable.nexusVswitch': '<fmt:message key="message.action.disable.nexusVswitch" />',
'message.action.enable.nexusVswitch': '<fmt:message key="message.action.enable.nexusVswitch" />',
