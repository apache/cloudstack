...
public class ListTungstenFabricNetworkCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        List<TungstenFabricNetworkResponse> tungstenFabricNetworkResponseList = tungstenService.listTungstenNetwork(
            zoneId, networkUuid);
        ListResponse<TungstenFabricNetworkResponse> listResponse = new ListResponse<>();
        listResponse.setResponses(tungstenFabricNetworkResponseList);
