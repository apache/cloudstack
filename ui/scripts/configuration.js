                        ...
                        add: {
                            ...
                            createForm: {
                                ...
                                fields: {
                                    ...
                                    hostTags: {
                                        //Only one single host tag is supported at server-side. Multiple host tags are NOT supported at server-side.
                            ...
                            createForm: {
                                ...
                                preFilter: function (args) {
                                    ...
                                    args.$form.bind('change', function () {
                                        //when any field in the dialog is changed
                        ...
                        data: [
                          { id: 'GUEST', description: 'Guest' }
                                    ...
                                    */
                                    ...
                                    lbType: {
                                        //only shown when VPC is checked and LB service is checked
                            ...
                            action: function (args) {
                                ...
                                $.each(formData, function (key, value) {
                                    ...
                                    if (serviceData.length > 1) {
                                        if (serviceData[0] == 'service' &&
                                            ...
                                            serviceProviderMap[serviceData[1]] = formData['service.' + serviceData[1] + '.provider'];
                                        }
                                ...
                                $.ajax({
                                    ...
                                    data: inputData,
                                    type: "POST",
                                    //use POST instead of GET since the API call might be overlong and exceed size limit
                                    success: function (data) {
