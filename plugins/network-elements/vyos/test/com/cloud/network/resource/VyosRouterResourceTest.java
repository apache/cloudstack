...
public class VyosRouterResourceTest {
     ...
     * public void implementGuestNetwork() throws ConfigurationException,
     ...
     * _resource.configure("VyosRouterResource", _resourceParams);
     *
     * IpAddressTO ip = new IpAddressTO(Long.valueOf("1"), "192.168.99.102",
     * true, false, true, "untagged", null, null, null, 100, false);
     * IpAddressTO[] ips = new IpAddressTO[1]; ips[0] = ip; IpAssocCommand cmd =
     * new IpAssocCommand(ips);
     * cmd.setAccessDetail(NetworkElementCommand.GUEST_NETWORK_GATEWAY,
     * "10.3.96.1");
     ...
     */
    /*
     * @Test // remove public & private interface details, source nat, guest
     * network public void shutdownGuestNetwork() throws ConfigurationException,
     * ExecutionException { if (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     *
     * IpAddressTO ip = new IpAddressTO(Long.valueOf("1"), "192.168.99.102",
     * false, false, true, "untagged", null, null, null, 100, false);
     * IpAddressTO[] ips = new IpAddressTO[1]; ips[0] = ip; IpAssocCommand cmd =
     * new IpAssocCommand(ips);
     * cmd.setAccessDetail(NetworkElementCommand.GUEST_NETWORK_GATEWAY,
     * "10.3.96.1");
     ...
     *
     * IpAssocAnswer answer = (IpAssocAnswer)_resource.executeRequest(cmd);
     * assertTrue(answer.getResult()); if
     * (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
    ...
    /*
     * @Test public void addIngressFirewallRule() throws ConfigurationException,
     ...
     * _resource.configure("VyosRouterResource", _resourceParams);
     *
     * long vlanId = 3954; List<FirewallRuleTO> rules = new
     * ArrayList<FirewallRuleTO>(); List<String> cidrList = new
     * ArrayList<String>(); cidrList.add("0.0.0.0/0"); //FirewallRuleTO active =
     * new FirewallRuleTO(8, null, "192.168.99.103", "tcp", 80, 80, false,
     * false, FirewallRule.Purpose.Firewall, cidrList, null, null);
     * FirewallRuleTO active = new FirewallRuleTO(8, null, "192.168.99.102",
     * "tcp", 22, 22, false, false, FirewallRule.Purpose.Firewall, cidrList,
     * null, null); rules.add(active);
     *
     * SetFirewallRulesCommand cmd = new SetFirewallRulesCommand(rules);
     * cmd.setContextParam(NetworkElementCommand.GUEST_VLAN_TAG,
     * Long.toString(vlanId));
     * cmd.setContextParam(NetworkElementCommand.GUEST_NETWORK_CIDR,
     * "10.3.96.0/24");
     *
    ...
    /*
     * @Test public void removeIngressFirewallRule() throws
     * ConfigurationException, Exception { if
     * (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     *
     * long vlanId = 3954; List<FirewallRuleTO> rules = new
     * ArrayList<FirewallRuleTO>(); //FirewallRuleTO revoked = new
     * FirewallRuleTO(8, null, "192.168.99.103", "tcp", 80, 80, true, false,
     * FirewallRule.Purpose.Firewall, null, null, null); FirewallRuleTO revoked
     * = new FirewallRuleTO(8, null, "192.168.99.102", "tcp", 22, 22, true,
     * false, FirewallRule.Purpose.Firewall, null, null, null);
     * rules.add(revoked);
     *
     * SetFirewallRulesCommand cmd = new SetFirewallRulesCommand(rules);
     * cmd.setContextParam(NetworkElementCommand.GUEST_VLAN_TAG,
    ...
    /*
     *
     * @Test public void addEgressFirewallRule() throws ConfigurationException,
     * Exception { if (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     * long vlanId = 3954; List<FirewallRuleTO> rules = new
     * ArrayList<FirewallRuleTO>(); List<String> cidrList = new
     * ArrayList<String>(); cidrList.add("0.0.0.0/0"); FirewallRuleVO activeVO =
     * new FirewallRuleVO(null, null, 80, 80, "tcp", 1, 1, 1, Purpose.Firewall,
     * cidrList, null, null, null, FirewallRule.TrafficType.Egress);
     * FirewallRuleTO active = new FirewallRuleTO(activeVO,
     * Long.toString(vlanId), null, Purpose.Firewall,
    ...
    /*
     * @Test public void removeEgressFirewallRule() throws
     * ConfigurationException, Exception { if
     * (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     *
     * long vlanId = 3954; List<FirewallRuleTO> rules = new
     * ArrayList<FirewallRuleTO>(); FirewallRuleVO revokedVO = new
     * FirewallRuleVO(null, null, 80, 80, "tcp", 1, 1, 1, Purpose.Firewall,
     * null, null, null, null, FirewallRule.TrafficType.Egress);
     * revokedVO.setState(State.Revoke); FirewallRuleTO revoked = new
     * FirewallRuleTO(revokedVO, Long.toString(vlanId), null, Purpose.Firewall,
     * FirewallRule.TrafficType.Egress); rules.add(revoked);
     *
     * SetFirewallRulesCommand cmd = new SetFirewallRulesCommand(rules);
     * cmd.setContextParam(NetworkElementCommand.GUEST_VLAN_TAG,
     * Long.toString(vlanId));
    ...
    /*
     * @Test public void addStaticNatRule() throws ConfigurationException,
     * Exception { if (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     * _resource.configure("VyosRouterResource", _resourceParams);
     *
     * System.out.println("Starting Execute"); long vlanId = 3954;
     * List<StaticNatRuleTO> rules = new ArrayList<StaticNatRuleTO>();
     * //StaticNatRuleTO active = new StaticNatRuleTO(9, "192.168.99.103", null,
     * null, "10.3.97.158", null, null, null, false, false); StaticNatRuleTO
     * active = new StaticNatRuleTO(9, "192.168.99.103", null, null,
     * "10.3.96.3", null, null, null, false, false); rules.add(active);
     *
     ...
     *
     * Answer answer = _resource.executeRequest(cmd);
     * System.out.println("Finished Execute"); assertTrue(answer.getResult());
     * if (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     */
    /*
     * @Test public void removeStaticNatRule() throws ConfigurationException,
     * Exception { if (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     * _resource.configure("VyosRouterResource", _resourceParams);
     *
     * long vlanId = 3954; List<StaticNatRuleTO> rules = new
     * ArrayList<StaticNatRuleTO>(); //StaticNatRuleTO revoked = new
     * StaticNatRuleTO(9, "192.168.99.103", null, null, "10.3.97.158", null,
     * null, null, true, false); StaticNatRuleTO revoked = new
     * StaticNatRuleTO(9, "192.168.99.103", null, null, "10.3.96.3", null, null,
     * null, true, false); rules.add(revoked);
     *
     * SetStaticNatRulesCommand cmd = new SetStaticNatRulesCommand(rules, null);
     * cmd.setContextParam(NetworkElementCommand.GUEST_VLAN_TAG,
     * Long.toString(vlanId));
    ...
    /*
     * @Test public void addPortForwardingRule() throws ConfigurationException,
     * Exception { if (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     * _resource.configure("VyosRouterResource", _resourceParams);
     *
     * long vlanId = 3954; List<PortForwardingRuleTO> rules = new
     * ArrayList<PortForwardingRuleTO>(); //PortForwardingRuleTO active = new
     * PortForwardingRuleTO(10, "192.168.99.103", 80, 80, "10.3.97.158", 8080,
     * 8080, "tcp", false, false); PortForwardingRuleTO active = new
     * PortForwardingRuleTO(10, "192.168.99.102", 22, 22, "10.3.96.2", 22, 22,
     * "tcp", false, false); rules.add(active);
     *
     * SetPortForwardingRulesCommand cmd = new
     * SetPortForwardingRulesCommand(rules);
     * cmd.setContextParam(NetworkElementCommand.GUEST_VLAN_TAG,
     * Long.toString(vlanId));
     * cmd.setContextParam(NetworkElementCommand.GUEST_NETWORK_CIDR,
     * "10.3.96.0/24");
    ...
    /*
     * @Test public void removePortForwardingRule() throws
     * ConfigurationException, Exception { if
     * (_context.containsKey("enable_console_output") &&
     * _context.get("enable_console_output").equals("true")) {
     ...
     *
     * long vlanId = 3954; List<PortForwardingRuleTO> rules = new
     * ArrayList<PortForwardingRuleTO>(); //PortForwardingRuleTO revoked = new
     * PortForwardingRuleTO(10, "192.168.99.103", 80, 80, "10.3.97.158", 8080,
     * 8080, "tcp", true, false); PortForwardingRuleTO revoked = new
     * PortForwardingRuleTO(10, "192.168.99.102", 22, 22, "10.3.96.2", 22, 22,
     * "tcp", true, false); rules.add(revoked);
     *
     * SetPortForwardingRulesCommand cmd = new
     * SetPortForwardingRulesCommand(rules);
     * cmd.setContextParam(NetworkElementCommand.GUEST_VLAN_TAG,
