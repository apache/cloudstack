...
@APICommand(name = "deleteVmwareCbtMigration",
        description = "Deletes a failed, cancelled or completed VMware CBT migration record. Failed and cancelled migrations can optionally clean up replicated target disks; completed migrations are record-only deletes.",
...
public class DeleteVmwareCbtMigrationCmd extends BaseCmd {
    ...
    @Parameter(name = ApiConstants.CLEANUP, type = CommandType.BOOLEAN,
            description = "If true, clean up replicated target disks before removing a failed or cancelled migration record. True by default. Ignored for completed migrations.")
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        boolean result = vmwareCbtMigrationManager.deleteVmwareCbtMigration(this);
