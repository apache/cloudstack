                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ExportTaskIdType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ExportTaskIdType",
    ...
    public static class Factory{
        ...
        */
        public static ExportTaskIdType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExportTaskIdType object =
                new ExportTaskIdType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ExportTaskIdType".equals(type)){
                                ...
                                return (ExportTaskIdType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
