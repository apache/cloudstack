...
public class VolumeStatusItemType implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":VolumeStatusItemType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "VolumeStatusItemType", xmlWriter);
            }
        ...
        localVolumeStatus.serialize(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "volumeStatus"), factory, xmlWriter);

        if (localEventsSet == null) {
            throw new org.apache.axis2.databinding.ADBException("eventsSet cannot be null!!");
        }
        localEventsSet.serialize(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "eventsSet"), factory, xmlWriter);

        if (localActionsSet == null) {
            throw new org.apache.axis2.databinding.ADBException("actionsSet cannot be null!!");
        }
        localActionsSet.serialize(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "actionsSet"), factory, xmlWriter);
    ...
    */
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "volumeStatus"));
        ...
        elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "eventsSet"));
        ...
        elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "actionsSet"));
    ...
    public static class Factory {
        ...
        */
        public static VolumeStatusItemType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            VolumeStatusItemType object = new VolumeStatusItemType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"VolumeStatusItemType".equals(type)) {
                            ...
                            return (VolumeStatusItemType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
