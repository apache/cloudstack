...
public interface VmwareCbtMigrationManager extends PluggableService {
    VmwareCbtMigrationPreflightResponse checkVmwareCbtMigrationPrerequisites(CheckVmwareCbtMigrationPrerequisitesCmd cmd);
    ...
    boolean deleteVmwareCbtMigration(DeleteVmwareCbtMigrationCmd cmd);
}
