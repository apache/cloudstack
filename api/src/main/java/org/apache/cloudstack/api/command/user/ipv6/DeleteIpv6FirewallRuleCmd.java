...
@APICommand(name = "deleteIpv6FirewallRule", description = "Deletes a IPv6 firewall rule", responseObject = SuccessResponse.class,
...
public class DeleteIpv6FirewallRuleCmd extends BaseAsyncCmd {
    ...
    private static final String s_name = "deleteipv6firewallruleresponse";
