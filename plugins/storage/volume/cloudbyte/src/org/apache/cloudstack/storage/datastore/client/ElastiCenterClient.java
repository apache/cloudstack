...
public class ElastiCenterClient {
	...
	private String REST_PROTOCOL = "https://";
	private String REST_PATH = "/client/api";
	private String REST_DEFAULT_COMMAND = "listCapabilities";
	
	private String QUERY_PARAM_COMMAND = "command";
	private String QUERY_PARAM_APIKEY = "apikey";
	private String QUERY_PARAM_RESPONSE = "response";
	...
	public void initialize() throws
		...
		try {
			initialized = true;
			listCapabilitiesResponse = (ListCapabilitiesResponse) executeCommand(REST_DEFAULT_COMMAND, null, new ListCapabilitiesResponse() );
	...
	public Object executeCommand( String command, MultivaluedMap<String, String> params, Object responeObj ) throws Throwable {
		...
		try {
			...
			WebResource webResource = client.resource(UriBuilder.fromUri(REST_PROTOCOL + elastiCenterAddress + REST_PATH ).build());
			
			MultivaluedMap<String, String> queryParams = new MultivaluedMapImpl();
			queryParams.add(QUERY_PARAM_APIKEY, apiKey);
			queryParams.add(QUERY_PARAM_RESPONSE, responseType );
			
			queryParams.add(QUERY_PARAM_COMMAND, command);
