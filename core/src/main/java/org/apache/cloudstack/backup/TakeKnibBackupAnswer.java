...
public class TakeKnibBackupAnswer extends Answer {
    ...
    public TakeKnibBackupAnswer(Command command, boolean success, Map<String, String> mapVolumeUuidToNewVolumePath,
    ...
    public TakeKnibBackupAnswer(Command command, Exception e) {
        super(command, e);
