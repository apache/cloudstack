...
public class VmwareCbtMigrationCutoverPolicyTest {
    ...
    @Test
    public void testLongRunningAgentCommandTimeoutDefaultIsOneDay() {
        Assert.assertEquals("86400", VmwareCbtMigrationManagerImpl.VmwareCbtMigrationAgentCommandTimeout.defaultValue());
    }
