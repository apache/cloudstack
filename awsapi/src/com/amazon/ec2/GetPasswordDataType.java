 ...
 */
        ...
        public  class GetPasswordDataType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetPasswordDataType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetPasswordDataType",
    ...
    public static class Factory{
        ...
        */
        public static GetPasswordDataType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPasswordDataType object =
                new GetPasswordDataType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetPasswordDataType".equals(type)){
                                ...
                                return (GetPasswordDataType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
