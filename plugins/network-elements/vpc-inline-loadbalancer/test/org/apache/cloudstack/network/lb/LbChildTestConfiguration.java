...
public class LbChildTestConfiguration {
    public static class Library implements TypeFilter {
        ...
        @Bean
        public VpcInlineLbMappingDao vpcInlineLbMappingDao() {
            return Mockito.mock(VpcInlineLbMappingDao.class);
        }
        ...
        @Bean
        public NicSecondaryIpDao nicSecondaryIpDao() {
            return Mockito.mock(NicSecondaryIpDao.class);
        }

        @Bean
        public LoadBalancerDao lbDao() {
