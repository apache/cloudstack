...
/**
*  CreateBucket bean class
*/

public class CreateBucket implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CreateBucket".equals(type)) {
                            ...
                            return (CreateBucket)com.amazon.s3.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
