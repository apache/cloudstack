...
public class ApiConstants {
    ...
    // Tungsten-Fabric
    public static final String TUNGSTEN_VMS = "tungstenvms";
    public static final String TUNGSTEN_NETWORK_ROUTE_TABLE_NAME = "tungstennetworkroutetablename";
    public static final String TUNGSTEN_INTERFACE_ROUTE_TABLE_NAME = "tungsteninterfaceroutetablename";
    public static final String TUNGSTEN_NETWORK_ROUTE_TABLE_UUID = "tungstennetworkroutetableuuid";
    public static final String TUNGSTEN_INTERFACE_ROUTE_TABLE_UUID = "tungsteninterfaceroutetableuuid";
    public static final String TUNGSTEN_ROUTING_POLICY_UUID = "tungstenroutingpolicyuuid";
    ...
    public static final String TUNGSTEN_ROUTING_POLICY_TERM_ADD_COMMUNITY = "tungstenroutingpolicytermaddcommunity";
    public static final String TUNGSTEN_ROUTING_POLICY_TERM_SET_COMMUNITY = "tungstenroutingpolicytermsetcommunity";
    public static final String TUNGSTEN_ROUTING_POLICY_TERM_REMOVE_COMMUNITY = "tungstenroutingpolicytermremovecommunity";
    public static final String TUNGSTEN_ROUTING_POLICY_TERM_LOCAL_PREFERENCE = "tungstenroutingpolicytermlocalpreference";
    public static final String TUNGSTEN_ROUTING_POLICY_TERM_MED = "tungstenroutingpolicytermmed";
    public static final String TUNGSTEN_ROUTING_POLICY_TERM_ACTION = "tungstenroutingpolicytermaction";
    public static final String TUNGSTEN_ROUTING_POLICY_TERM_AS_PATH = "tungstenroutingpolicytermaspath";
    public static final String TUNGSTEN_ROUTING_POLICY_COMMUNITIES = "tungstenroutingpolicycommunities";
    public static final String TUNGSTEN_ROUTING_POLICY_MATCH_ALL = "tungstenroutingpolicymatchall";
    public static final String TUNGSTEN_ROUTING_POLICY_PROTOCOL = "tungstenroutingpolicyprotocol";
    public static final String TUNGSTEN_ROUTING_POLICY_PREFIX = "tungstenroutingpolicyprefix";
    public static final String TUNGSTEN_ROUTING_POLICY_PREFIX_TYPE = "tungstenroutingpolicyprefixtype";
    public static final String TUNGSTEN_ROUTING_POLICY_PREFIX_LIST = "tungstenroutingpolicyprefixlist";
    public static final String TUNGSTEN_ROUTING_POLICY_FROM_TERM = "tungstenroutingpolicyfromterm";
    public static final String TUNGSTEN_ROUTING_POLICY_THEN_TERM = "tungstenroutingpolicythenterm";
    public static final String TUNGSTEN_ROUTING_POLICY_TERM = "tungstenroutingpolicyterm";
    public static final String TUNGSTEN_ROUTING_POLICY_TERM_NAME = "tungstenroutingpolicytermname";
    public static final String TUNGSTEN_ROUTING_POLICY_FROM_TERM_COMMUNITIES = "tungstenroutingpolicyfromtermcommunities";
    public static final String TUNGSTEN_ROUTING_POLICY_FROM_TERM_PREFIX_LIST = "tungstenroutingpolicyfromtermprefixlist";
    public static final String TUNGSTEN_ROUTING_POLICY_THEN_TERM_LIST = "tungstenroutingpolicythentermlist";
    ...
    public static final String INTERFACE_ROUTE_PREFIX = "interfacerouteprefix";
    public static final String ROUTE_NEXT_HOP_TYPE = "routenexthoptype";
    public static final String ROUTE_NEXT_HOP = "routenexthop";
    public static final String IS_ATTACHED_TO_NETWORK = "isattachedtonetwork";
    public static final String IS_ATTACHED_TO_INTERFACE = "isattachedtointerface";
    public static final String COMMUNITIES = "communities";
    public static final String INTERFACE_COMMUNITIES = "interfacecommunities";
