...
public class Upgrade41600to41700 implements DbUpgrade, DbUpgradeSystemVmTemplate {

    final static Logger LOG = Logger.getLogger(Upgrade41600to41700.class);
    private SystemVmTemplateRegistration systemVmTemplateRegistration;

    public Upgrade41600to41700() {
    }

    @Override
    public String[] getUpgradableVersionRange() {
        return new String[] {"4.16.0.0", "4.17.0.0"};
    }
    ...
    public InputStream[] getPrepareScripts() {
        final String scriptFile = "META-INF/db/schema-41600to41700.sql";
    ...
    public InputStream[] getCleanupScripts() {
        final String scriptFile = "META-INF/db/schema-41600to41700-cleanup.sql";
        final InputStream script = Thread.currentThread().getContextClassLoader().getResourceAsStream(scriptFile);
        if (script == null) {
            throw new CloudRuntimeException("Unable to find " + scriptFile);
        }
