...
public class CreateTungstenFabricTagCmdTest {
    ...
    public void executeTest() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        Mockito.when(tungstenService.createTungstenTag(ArgumentMatchers.anyLong(), ArgumentMatchers.anyString(),
                ArgumentMatchers.anyString())).thenReturn(tungstenFabricTagResponse);
        createTungstenFabricTagCmd.execute();
        Assert.assertEquals(tungstenFabricTagResponse, createTungstenFabricTagCmd.getResponseObject());
    }
}
