...
public class RemoveInstanceBootGroupMemberCmd extends BaseCmd implements UserCmd {
    ...
    @Override
    public void execute() {
        boolean result = instanceBootGroupService.removeInstanceBootGroupMember(this);
        if (!result) {
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to remove member from instance boot group");
        }
