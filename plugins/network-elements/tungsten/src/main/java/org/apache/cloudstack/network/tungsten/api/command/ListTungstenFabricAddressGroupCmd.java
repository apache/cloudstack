...
public class ListTungstenFabricAddressGroupCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        List<TungstenFabricAddressGroupResponse> tungstenFabricAddressGroupResponseList =
            tungstenService.listTungstenAddressGroup(
            zoneId, addressGroupUuid);
        ListResponse<TungstenFabricAddressGroupResponse> listResponse = new ListResponse<>();
        listResponse.setResponses(tungstenFabricAddressGroupResponseList);
