...
public class LinstorPrimaryDataStoreDriverImpl implements PrimaryDataStoreDriver {
    ...
    private boolean createResourceBase(
        String rscName, long sizeInBytes, String volName, String vmName, DevelopersApi api,
        ...
        try
        {
            ...
            if (!alreadyCreated) {
                ...
                if (createNewRsc) {
                    ...
                    spawnResource(api, newRscName, sizeInBytes, isTemplate, rscGrp, volName, vmName);
                }
                return createNewRsc;
            }
            return false;
