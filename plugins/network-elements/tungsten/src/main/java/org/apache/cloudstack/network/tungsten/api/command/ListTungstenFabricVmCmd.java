...
public class ListTungstenFabricVmCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        List<TungstenFabricVmResponse> tungstenFabricVmResponseList = tungstenService.listTungstenVm(zoneId, vmUuid);
        ListResponse<TungstenFabricVmResponse> listResponse = new ListResponse<>();
        listResponse.setResponses(tungstenFabricVmResponseList);
