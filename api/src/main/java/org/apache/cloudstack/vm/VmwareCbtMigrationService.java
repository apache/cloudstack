...
public interface VmwareCbtMigrationService {
    VmwareCbtPreflightInfo getPreflightInfo(String vcenter, String datacenterName, String username, String password,
    ...
    List<VmwareCbtDiskInfo> listSnapshotDisks(String vcenter, String datacenterName, String username, String password,
                                              String sourceHost, String sourceVmName, String snapshotMor);

    void ensureChangeTrackingEnabled(String vcenter, String datacenterName, String username, String password,
                                     String sourceHost, String sourceVmName);
    ...
    UnmanagedInstanceTO.PowerState getPowerState(String vcenter, String datacenterName, String username,
                                                 String password, String sourceHost, String sourceVmName);
