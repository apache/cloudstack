    ...
    cloudStack.uiCustom.systemChart = function (chartID, chartFunc) {
        ...
        var viewAllButton = function (args) {
            ...
            $viewAll.click(function () {
                if ($viewAll.data('multiple-click'))
                    return false;
                    ...
                    trafficTypeDataProvider({
                        ...
                        response: {
                            success: function (args) {
                                ...
                                var $switchIcon = $('<div>').addClass('network-switch-icon').append($('<span>').html('L2/L3 switch'));
                    ...
                    response: {
                        success: function (args) {
                            ...
                            $.each(chartItems, function (id, chartItem) {
                                ...
                                $chartItems.append($item.append($name, $value.append($content.append($allocatedValue, ' / ', $totalValue)), $chart.append($chartLine), $percent.append($percentValue, '%')));
                            });
                        }
                    }
                });
