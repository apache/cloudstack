    ...
    var installWizard = function (args) {
        ...
        var elems = {
            ...
            stepIntro: function (args) {
                ...
                return function (args) {
                    showDiagram(diagram);
                    return $intro.append($title, $subtitle, $copy, $prev, $continue);
                };
            },
            /**
            ...
            tooltip: function (title, content) {
                return $('<div>').addClass('tooltip-info').append($('<div>').addClass('arrow'), $('<div>').addClass('title').html(_l(title)), $('<div>').addClass('content').append($('<p>').html(_l(content))));
            },
            /**
             * The main header
             */
            header: function () {
                return $('<div></div>').addClass('header')
                    .append($.merge($('<h2></h2>').html(_l('label.installWizard.title')), $('<h3></h3>').html(_l('label.installWizard.subtitle'))));
            },
            /**
            ...
            diagramParts: function () {
                return $('<div>').addClass('diagram').append($('<div>').addClass('part zone'), $('<div>').addClass('part pod'), $('<div>').addClass('part cluster'), $('<div>').addClass('part host'), $('<div>').addClass('part primaryStorage'), $('<div>').addClass('part secondaryStorage'), $('<div>').addClass('part loading').append($('<div>').addClass('icon')));
            }
        };
        ...
        var showTooltip = function ($formContainer, sectionID) {
            ...
            $formContainer.find('input[type=text]').focus(function () {
                ...
                var content = getCopy('tooltip.' + sectionID + '.' + $input.attr('name'), $tooltip.find('p'));
            });
        ...
        var steps = {
            ...
            intro: function (args) {
                ...
                return $intro.append($title, $subtitle, $copy, $advanced, $continue);
            },
            changeUser: function (args) {
                ...
                $form.append($('<div></div>').addClass('title').html(_l('message.change.password')), $('<div></div>').addClass('field').append($('<label>' + _l('label.new.password') + ':</label>'), $password), $('<div></div>').addClass('field').append($('<label>' + _l('label.confirm.password') + ':</label>'), $passwordConfirm), $save);
                $form.validate({
                    rules: {
                        'password-confirm': {
                            equalTo: '#password'
            ...
            launchInfo: function (args) {
                ...
                return $intro.append($title, $subtitle, $prev, $continue);
            },
            /**
            ...
            launchInfoError: function (args) {
                ...
                showDiagram('.part.zone, .part.secondaryStorage');
                return $intro.append($title, $subtitle, $continue);
            },
            /**
                ...
                cloudStack.installWizard.action({
                    ...
                    response: {
                        ...
                        error: function (stepID, message, callback) {
                            ...
                            $subtitle.append($('<p>').html(_l('error.installWizard.message') + ':<br/>' + message), $('<div>').addClass('button').append($('<span>').html(_l('label.back'))).click(function () {
        ...
        $installWizard.append(elems.header(), elems.body().append(initialStep), $diagramParts).appendTo($container);
    };
