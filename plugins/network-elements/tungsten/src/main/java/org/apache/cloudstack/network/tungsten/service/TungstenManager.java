...
public interface TungstenManager extends PluggableService {
    ...
    ListResponse<TungstenVmInterfaceResponse> getVmInterfaces(ListTungstenVmInterfaceCmd cmd) throws IOException;
    ListResponse<TungstenVirtualMachineResponse> getVirtualMachines(ListTungstenVirtualMachineCmd cmd) throws IOException;
    ...
    ApiObjectBase getTungstenObjectByUUID(Class<? extends ApiObjectBase> cls, String uuid) throws IOException;
}
