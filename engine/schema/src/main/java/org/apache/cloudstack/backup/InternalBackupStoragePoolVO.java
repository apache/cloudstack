...
@Entity
@Table(name = "internal_backup_pool_ref")
public class InternalBackupStoragePoolVO implements InternalIdentity {
    @Id
    ...
    public InternalBackupStoragePoolVO() {
    }

    public InternalBackupStoragePoolVO(long backupId, long storagePoolId, long volumeId, String backupDeltaPath, String backupDeltaParentPath) {
