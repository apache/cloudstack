...
@APICommand(name = "resizeFileShare",
        responseObject= FileShareResponse.class,
        description = "Resize a File Share.. ",
        responseView = ResponseObject.ResponseView.Restricted,
        entityType = FileShare.class,
        requestHasSensitiveInfo = false,
        since = "4.20.0",
        authorized = {RoleType.Admin, RoleType.ResourceAdmin, RoleType.DomainAdmin, RoleType.User})
public class ResizeFileShareCmd extends BaseAsyncCmd implements UserCmd {
    ...
    public String getEventDescription() {
        return "Changing size of the fileshare " + id;
    }
    ...
    @Override
    public void execute() {
        FileShare fileShare = fileShareService.resizeFileShare(this);
        if (fileShare != null) {
