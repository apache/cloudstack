...
<div class="maincontent" style="display:block;" id="submenu_content_global">
	...
	<div class="grid_container">
		...
		<div class="grid_header">
	        <div class="grid_genheader_cell" id="name_header" style="width:30%;">
            	<div class="grid_headertitles">Name</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="value_header" style="width:15%;">
            	<div class="grid_headertitles">Value</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
             <div class="grid_genheader_cell" id="description_header" style="width:50%;">
...
<div class="maincontent" style="display:none;" id="submenu_content_service">
	...
	<div class="grid_container">
		<div class="grid_header">
		    <div class="grid_genheader_cell" id="id_header" style="width:4%;">
            	<div class="grid_headertitles">ID</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="name_header" style="width:10%;">
            	<div class="grid_headertitles">Name</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="displaytext_header" style="width:16%;">
            	<div class="grid_headertitles">Display text</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="storagetype_header" style="width:7%;">
            	<div class="grid_headertitles">Storage type</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="cpu_header" style="width:10%;">
            	<div class="grid_headertitles">CPU</div>
            	<!--
            	<div class="gridsorting_arrow"></div>		
            	-->
            </div>
            <div class="grid_genheader_cell" id="memory_header" style="width:10%;">
            	<div class="grid_headertitles">Memory</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="offerha_header" style="width:7%;">
            	<div class="grid_headertitles">Offer HA</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="networktype_header" style="width:7%;">
            	<div class="grid_headertitles">Network Type</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="tags_header" style="width:10%;">
            	<div class="grid_headertitles">Tags</div>
            	<div class="gridsorting_arrow"></div>		
            </div>
            <div class="grid_genheader_cell" id="created_header" style="width:10%;">
...
<div id="service_template" style="display:none">
    ...
    <div id="row_container">  
	    ...
	    <div class="grid_smallgenrow_cell" style="width:16%;">
		    <div class="netgrid_celltitles" id="service_displaytext"></div>
	    </div>
