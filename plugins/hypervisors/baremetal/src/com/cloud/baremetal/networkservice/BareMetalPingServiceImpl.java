...
public class BareMetalPingServiceImpl extends BareMetalPxeServiceBase implements BaremetalPxeService {
    ...
    @Override
    public boolean prepare(VirtualMachineProfile profile, NicProfile pxeNic, Network network, DeployDestination dest, ReservationContext context, List<BaremetalPxeVO> bareMetalPxeVOs) {
        BaremetalPxeVO pxeVo = bareMetalPxeVOs.get(0); // Only one PXE of type PING allowed in zone, check addPxeServer;
