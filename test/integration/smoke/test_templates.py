...
class TestActivateTemplate(cloudstackTestCase):
    ...
    def setUpClass(cls):
        ...
        self.test_template.format = "QCOW2"
        self.test_template.ostypeid = self.getOsType("Debian Linux 9 (64-bit)")
        self.md5 = "d40bce40b2d5bb4ba73e56d1e95aeae5"

        self.activatTemplateCmd = activatTemplate.activatTemplateCmd()
        return
    ...
    def test_01_activate_sytem_vm_template(self):
        ...
        template = self.registerTemplate(self.test_template)
        self.download(self.apiclient, template.id)
        self.activatTemplate(self.activatTemplateCmd)
    ...
    def activatTemplate(self, cmd):
        response = self.apiclient.activateSystemVMTemplateCmd(cmd)
        return response 
