...
public class KVMGuestOsMapper {
    ...
    static {
        ...
        s_mapper.put("CentOS 6.0 (32-bit)", "CentOS 6.0");
        s_mapper.put("CentOS 6.0 (64-bit)", "CentOS 6.0");
        s_mapper.put("CentOS 6.1 (32-bit)", "CentOS 6.1");
        s_mapper.put("CentOS 6.1 (64-bit)", "CentOS 6.1");
        s_mapper.put("CentOS 6.2 (32-bit)", "CentOS 6.2");
        s_mapper.put("CentOS 6.2 (64-bit)", "CentOS 6.2");
        s_mapper.put("CentOS 6.3 (32-bit)", "CentOS 6.3");
        s_mapper.put("CentOS 6.3 (64-bit)", "CentOS 6.3");
        s_mapper.put("CentOS 6.4 (32-bit)", "CentOS 6.4");
        s_mapper.put("CentOS 6.4 (64-bit)", "CentOS 6.4");
        s_mapper.put("CentOS 6.5 (32-bit)", "CentOS 6.5");
        s_mapper.put("CentOS 6.5 (64-bit)", "CentOS 6.5");
        s_mapper.put("CentOS 6.6 (32-bit)", "CentOS 6.6");
        s_mapper.put("CentOS 6.6 (64-bit)", "CentOS 6.6");
        s_mapper.put("CentOS 6.7 (32-bit)", "CentOS 6.7");
        s_mapper.put("CentOS 6.7 (64-bit)", "CentOS 6.7");
        s_mapper.put("CentOS 7.0-1406 (64-bit)", "CentOS 7.0-1406");
        s_mapper.put("CentOS 7.1-1503 (64-bit)", "CentOS 7.1-1503");
        s_mapper.put("CentOS 7.2-1511 (64-bit)", "CentOS 7.2-1511");
        ...
        s_mapper.put("Red Hat Enterprise Linux 6.1 (32-bit)", "Red Hat Enterprise Linux 6.1");
        s_mapper.put("Red Hat Enterprise Linux 6.1 (64-bit)", "Red Hat Enterprise Linux 6.1");
        s_mapper.put("Red Hat Enterprise Linux 6.2 (32-bit)", "Red Hat Enterprise Linux 6.2");
        s_mapper.put("Red Hat Enterprise Linux 6.2 (64-bit)", "Red Hat Enterprise Linux 6.2");
        s_mapper.put("Red Hat Enterprise Linux 6.3 (32-bit)", "Red Hat Enterprise Linux 6.3");
        s_mapper.put("Red Hat Enterprise Linux 6.3 (64-bit)", "Red Hat Enterprise Linux 6.3");
        s_mapper.put("Red Hat Enterprise Linux 6.4 (32-bit)", "Red Hat Enterprise Linux 6.4");
        s_mapper.put("Red Hat Enterprise Linux 6.4 (64-bit)", "Red Hat Enterprise Linux 6.4");
        s_mapper.put("Red Hat Enterprise Linux 6.5 (32-bit)", "Red Hat Enterprise Linux 6.5");
        s_mapper.put("Red Hat Enterprise Linux 6.5 (64-bit)", "Red Hat Enterprise Linux 6.5");
        s_mapper.put("Red Hat Enterprise Linux 6.6 (32-bit)", "Red Hat Enterprise Linux 6.6");
        s_mapper.put("Red Hat Enterprise Linux 6.6 (64-bit)", "Red Hat Enterprise Linux 6.6");
        s_mapper.put("Red Hat Enterprise Linux 6.7 (32-bit)", "Red Hat Enterprise Linux 6.7");
        s_mapper.put("Red Hat Enterprise Linux 6.7 (64-bit)", "Red Hat Enterprise Linux 6.7");
        s_mapper.put("Red Hat Enterprise Linux 7.0 (64-bit)", "Red Hat Enterprise Linux 7.0");
        s_mapper.put("Red Hat Enterprise Linux 7.1 (64-bit)", "Red Hat Enterprise Linux 7.1");
        s_mapper.put("Red Hat Enterprise Linux 7.2 (64-bit)", "Red Hat Enterprise Linux 7.2");
        s_mapper.put("Fedora 23", "Fedora 23");
        s_mapper.put("Fedora 22", "Fedora 22");
        s_mapper.put("Fedora 21", "Fedora 21");
        s_mapper.put("Fedora 20", "Fedora 20");
        s_mapper.put("Fedora 19", "Fedora 19");
        s_mapper.put("Fedora 18", "Fedora 18");
        s_mapper.put("Fedora 17", "Fedora 17");
        s_mapper.put("Fedora 16", "Fedora 16");
        s_mapper.put("Fedora 15", "Fedora 15");
        s_mapper.put("Fedora 14", "Fedora 14");
        ...
        s_mapper.put("Ubuntu 15.10 (32-bit)", "Ubuntu 15.10");
        s_mapper.put("Ubuntu 15.10 (64-bit)", "Ubuntu 15.10");
        s_mapper.put("Ubuntu 15.04 (32-bit)", "Ubuntu 15.04");
        s_mapper.put("Ubuntu 15.04 (64-bit)", "Ubuntu 15.04");
        ...
        s_mapper.put("Ubuntu 11.10 (32-bit)", "Ubuntu 11.10");
        s_mapper.put("Ubuntu 11.10 (64-bit)", "Ubuntu 11.10");
        s_mapper.put("Ubuntu 11.04 (32-bit)", "Ubuntu 11.04");
        s_mapper.put("Ubuntu 11.04 (64-bit)", "Ubuntu 11.04");
        ...
        s_mapper.put("Debian GNU/Linux 7(64-bit)", "Debian GNU/Linux 7");
        s_mapper.put("Debian GNU/Linux 7(32-bit)", "Debian GNU/Linux 7");
        s_mapper.put("Debian GNU/Linux 8(64-bit)", "Debian GNU/Linux 8");
        s_mapper.put("Debian GNU/Linux 8(32-bit)", "Debian GNU/Linux 8");
        ...
        s_mapper.put("Windows 10 (32-bit)", "Windows 10");
        s_mapper.put("Windows 10 (64-bit)", "Windows 10");
        s_mapper.put("Windows 8.1 (32-bit)", "Windows 8.1");
        s_mapper.put("Windows 8.1 (64-bit)", "Windows 8.1");
        s_mapper.put("Windows 8 (32-bit)", "Windows 8");
        s_mapper.put("Windows 8 (64-bit)", "Windows 8");
        ...
        s_mapper.put("Windows Server 2012 (64-bit)", "Windows Server 2012");
        s_mapper.put("Windows Server 2012 R2 (64-bit)", "Windows Server 2012 R2");
        ...
        s_mapper.put("FreeBSD 10 (64-bit)", "FreeBSD 10");
