...
/**
 * SetObjectAccessControlPolicy.java
 *
 ...
 */
            ...
            /**
            *  SetObjectAccessControlPolicy bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SetObjectAccessControlPolicy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SetObjectAccessControlPolicy",
    ...
    public static class Factory{
        ...
        */
        public static SetObjectAccessControlPolicy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetObjectAccessControlPolicy object =
                new SetObjectAccessControlPolicy();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SetObjectAccessControlPolicy".equals(type)){
                                ...
                                return (SetObjectAccessControlPolicy)com.amazon.s3.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
