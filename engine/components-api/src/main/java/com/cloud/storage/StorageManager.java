...
public interface StorageManager extends StorageService {
    ...
    ConfigKey<Boolean>  SecStorageVMScaleDown = new ConfigKey<Boolean>("Advanced", Boolean.class, "secstorage.vm.auto.scale.down", "false",
            "Setting this to 'true' will auto scale down SSVMs when there are no active commands” ", true, ConfigKey.Scope.Global);
