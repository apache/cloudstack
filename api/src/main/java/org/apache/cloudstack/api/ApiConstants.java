...
public class ApiConstants {
    ...
    public static final String READINESS_MODE = "readinessmode";
    public static final String READINESS_STATUS = "readinessstatus";
    public static final String READINESS_MESSAGE = "readinessmessage";
    public static final String READINESS_ATTEMPT_TIMEOUT_SECONDS = "readinessattempttimeoutseconds";
    public static final String READINESS_MAX_RETRY_ATTEMPTS = "readinessmaxretryattempts";
    public static final String READINESS_REBOOT_ON_RETRY = "readinessrebootonretry";
    public static final String READINESS_INITIAL_DELAY_SECONDS = "readinessinitialdelayseconds";
    public static final String IGNORE_INSTANCE_STATE = "ignoreinstancestate";
