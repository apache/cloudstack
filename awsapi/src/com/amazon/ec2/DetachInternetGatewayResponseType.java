 ...
 */
        ...
        public  class DetachInternetGatewayResponseType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DetachInternetGatewayResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static DetachInternetGatewayResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DetachInternetGatewayResponseType object =
                new DetachInternetGatewayResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DetachInternetGatewayResponseType".equals(type)){
                                ...
                                return (DetachInternetGatewayResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
