...
public interface InternalBackupJoinDao extends GenericDao<InternalBackupJoinVO, Long> {
    ...
    List<InternalBackupJoinVO> listByImageStoreId(long imageStoreId);

    List<InternalBackupJoinVO> listById(long id);

    List<InternalBackupJoinVO> listByParentId(long parentId);
}
