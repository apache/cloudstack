...
public interface VnfTemplateManager {
    ...
    static List<VNF.VnfNic> getVnfNicsList(Map vnfNics) {
    ...
    static void validateApiCommandParams(Map<String, String> vnfDetails, List<VNF.VnfNic> vnfNics, String templateType) {
        ...
        VnfTemplateManager.validateVnfNics(vnfNics);
    }

    static void validateVnfNics(List<VNF.VnfNic> nicsList) {
        int deviceId = 0;
    ...
    static void validateApiCommandParams(BaseCmd cmd, VirtualMachineTemplate template) {
        if (cmd instanceof RegisterVnfTemplateCmd) {
            RegisterVnfTemplateCmd registerCmd = (RegisterVnfTemplateCmd) cmd;
            VnfTemplateManager.validateApiCommandParams(registerCmd.getVnfDetails(), registerCmd.getVnfNics(), registerCmd.getTemplateType());
            ...
            VnfTemplateManager.validateApiCommandParams(updateCmd.getVnfDetails(), updateCmd.getVnfNics(), updateCmd.getTemplateType());
