    ...
    cloudStack.routingPolicyWizard = {
        ...
        preFilters: {
            routingPolicyFromTerm: function(args) {
                var $addTungstenRoutingPolicyTermFrom = $('.routing-policy-wizard:visible').find('#add_tungsten_routing_policy_term_from');
                $addTungstenRoutingPolicyTermFrom.find('#from_term').css('display', 'inline');
                return true;
            },
            ...
            routingPolicy: {
                fields: {
                    name: {
                        ...
                        desc: 'message.tooltip.routing.policy.name'
                    }
                }
            },
