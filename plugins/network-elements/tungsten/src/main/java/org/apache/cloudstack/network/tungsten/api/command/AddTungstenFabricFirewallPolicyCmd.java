...
@APICommand(name = AddTungstenFabricFirewallPolicyCmd.APINAME, description = "add Tungsten-Fabric firewall policy",
    responseObject = TungstenFabricApplicationPolicySetResponse.class, requestHasSensitiveInfo = false,
    responseHasSensitiveInfo = false)
public class AddTungstenFabricFirewallPolicyCmd extends BaseAsyncCmd {
    public static final Logger s_logger = Logger.getLogger(AddTungstenFabricFirewallPolicyCmd.class.getName());
    public static final String APINAME = "addTungstenFabricFirewallPolicy";
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        TungstenFabricApplicationPolicySetResponse tungstenFabricApplicationPolicySetResponse =
            tungstenService.addTungstenFirewallPolicy(
            zoneId, applicationPolicySetUuid, firewallPolicyUuid, tagUuid, sequence);
        if (tungstenFabricApplicationPolicySetResponse == null) {
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR,
                "Failed to applied Tungsten-Fabric application policy set");
        } else {
    ...
    public String getEventType() {
        return EventTypes.EVENT_TUNGSTEN_ADD_FIREWALL_POLICY;
    }

    @Override
    public String getEventDescription() {
        return "add Tungsten-Fabric firewall policy";
    }
