...
public class DatabaseUpgradeChecker implements SystemIntegrityChecker {
    ...
    public DatabaseUpgradeChecker() {
        ...
        _upgradeMap.put("2.1.7", new DbUpgrade[] { new Upgrade217to218(), new Upgrade218to22(), new Upgrade221to222(),
                ...
                new Upgrade410to411(), new Upgrade411to412(), new Upgrade412to420() });
        ...
        _upgradeMap.put("4.1.0", new DbUpgrade[] { new Upgrade410to411(), new Upgrade411to412(), new Upgrade412to420() });

        _upgradeMap.put("4.1.1", new DbUpgrade[] { new Upgrade411to412(), new Upgrade412to420() });
        ...
        _upgradeMap.put("3.0.4", new DbUpgrade[] { new Upgrade304to305(), new Upgrade305to306(), new Upgrade306to307(), new Upgrade307to410(),
                new Upgrade410to411(), new Upgrade411to412(), new Upgrade412to420() });
        
        _upgradeMap.put("3.0.5", new DbUpgrade[] { new Upgrade305to306(), new Upgrade306to307(), new Upgrade307to410(),
                new Upgrade410to411(), new Upgrade411to412(), new Upgrade412to420() });
        
        _upgradeMap.put("3.0.6", new DbUpgrade[] { new Upgrade306to307(), new Upgrade307to410(),
                new Upgrade410to411(), new Upgrade411to412(), new Upgrade412to420() });
