    ...
    public boolean delete(TemplateProfile profile) {
        ...
        if (imageStores == null || imageStores.size() == 0) {
            ...
            for (DataStore imageStore : imageStores) {
                ...
                if (sZoneId != null) {
                    _usageEventEmitter.publishUsageEvent(eventType, template.getAccountId(), sZoneId, template.getId(), null, VirtualMachineTemplate.class.getName(), template.getUuid());
                }
