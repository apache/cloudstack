        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.amazon.s3.Grant[] localGrant ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.amazon.s3.Grant[]
                           */
                           public  com.amazon.s3.Grant[] getGrant(){
                               return localGrant;
                           }
                               ...
                               */
                              protected void validateGrant(com.amazon.s3.Grant[] param){
                              ...
                              * @param param Grant
                              */
                              public void setGrant(com.amazon.s3.Grant[] param){
                             ...
                             * @param param com.amazon.s3.Grant
                             */
                             public void addGrant(com.amazon.s3.Grant param){
                                   if (localGrant == null){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localGrant);
                               list.add(param);
                               this.localGrant =
                             (com.amazon.s3.Grant[])list.toArray(
                            new com.amazon.s3.Grant[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AccessControlList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AccessControlList",
                                       ...
                                       if (localGrant!=null){
                                            for (int i = 0;i < localGrant.length;i++){
                                                if (localGrant[i] != null){
                                                 localGrant[i].serialize(new javax.xml.namespace.QName("http://s3.amazonaws.com/doc/2006-03-01/","Grant"),
                                                           factory,xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AccessControlList".equals(type)){
                                ...
                                return (AccessControlList)com.amazon.s3.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(com.amazon.s3.Grant.Factory.parse(reader));
                                                        ...
                                                        object.setGrant((com.amazon.s3.Grant[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.amazon.s3.Grant.class,
                                                                list1));
