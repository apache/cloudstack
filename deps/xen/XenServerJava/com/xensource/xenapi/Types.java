...
public class Types
{
    ...
    /**
     * The SR.shared flag cannot be set to false while there it remains connected to multiple hosts
     */
    public static class SrHasMultiplePbds extends XenAPIException {
        ...
        public SrHasMultiplePbds(String PBD) {
            super("The SR.shared flag cannot be set to false while there it remains connected to multiple hosts");
            this.PBD = PBD;
        }
