...
@APICommand(name = "checkVmwareCbtMigrationPrerequisites",
        description = "Check whether a VMware VM and KVM destination are ready for VMware CBT based migration",
        responseObject = VmwareCbtMigrationPreflightResponse.class,
        responseView = ResponseObject.ResponseView.Full,
        requestHasSensitiveInfo = true,
        responseHasSensitiveInfo = false,
        authorized = {RoleType.Admin},
        since = "4.22.1")
public class CheckVmwareCbtMigrationPrerequisitesCmd extends BaseCmd {
    ...
    @Parameter(name = ApiConstants.CONVERT_INSTANCE_HOST_ID, type = CommandType.UUID, entityType = HostResponse.class,
            description = "optional KVM host to perform CBT block replication")
    ...
    @Parameter(name = ApiConstants.SERVICE_OFFERING_ID, type = CommandType.UUID, entityType = ServiceOfferingResponse.class,
            description = "optional service offering to validate against the source VM CPU and memory requirements")
    private Long serviceOfferingId;

    @Parameter(name = ApiConstants.DETAILS, type = CommandType.MAP,
            description = "optional service offering custom parameters and migration details")
    private Map details;
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        VmwareCbtMigrationPreflightResponse response = vmwareCbtMigrationManager.checkVmwareCbtMigrationPrerequisites(this);
