...
public class VmwareCbtMigrationResponse extends BaseResponse {
    ...
    @SerializedName("currentstepduration")
    @Param(description = "the elapsed time spent in the current migration step")
    private String currentStepDuration;
    ...
    public void setCurrentStepDuration(String currentStepDuration) {
