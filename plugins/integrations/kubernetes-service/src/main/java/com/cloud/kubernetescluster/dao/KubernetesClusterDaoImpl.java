...
import com.cloud.kubernetescluster.KubernetesCluster.Event;
...
public class KubernetesClusterDaoImpl extends GenericDaoBase<KubernetesClusterVO, Long> implements KubernetesClusterDao {
    ...
    @Override
    public boolean updateState(KubernetesCluster.State currentState, Event event, KubernetesCluster.State nextState,
