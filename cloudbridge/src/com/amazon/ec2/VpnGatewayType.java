 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.amazon.ec2.AttachmentSetType localAttachments ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.amazon.ec2.AttachmentSetType
                           */
                           public  com.amazon.ec2.AttachmentSetType getAttachments(){
                            ...
                            /**
                               ...
                               */
                               public void setAttachments(com.amazon.ec2.AttachmentSetType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       VpnGatewayType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VpnGatewayType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VpnGatewayType",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localAttachments.serialize(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2010-11-15/","attachments"),
                                               factory,xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static VpnGatewayType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VpnGatewayType object =
                new VpnGatewayType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VpnGatewayType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VpnGatewayType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2010-11-15/","attachments").equals(reader.getName())){
                                
                                                object.setAttachments(com.amazon.ec2.AttachmentSetType.Factory.parse(reader));
