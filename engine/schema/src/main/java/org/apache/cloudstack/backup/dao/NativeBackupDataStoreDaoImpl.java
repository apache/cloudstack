...
import org.apache.cloudstack.backup.NativeBackupDataStoreVO;

import javax.annotation.PostConstruct;
import java.util.List;

public class NativeBackupDataStoreDaoImpl extends GenericDaoBase<NativeBackupDataStoreVO, Long> implements NativeBackupDataStoreDao {

    private SearchBuilder<NativeBackupDataStoreVO> backupSearch;
    ...
    @Override
    public List<NativeBackupDataStoreVO> listByBackupId(long backupId) {
    ...
    public void updateVolumeId(long oldVolumeId, long newVolumeId) {
        ...
        NativeBackupDataStoreVO delta = createForUpdate();
