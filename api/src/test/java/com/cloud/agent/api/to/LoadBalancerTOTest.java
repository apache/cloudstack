...
public class LoadBalancerTOTest {
    ...
    private static final String counterUiid = "1111-1111-1100";
    ...
    private static final String conditionUiid = "1111-1111-1110";
    ...
    private static final String scaleUpPolicyUiid = "1111-1111-1111";
    ...
    @Before
    public void setUp() {
        counter = new LoadBalancerTO.CounterTO(counterId, counterUiid, counterName, counterSource, counterValue, counterProvider);
        condition = new LoadBalancerTO.ConditionTO(conditionId, conditionUiid, threshold, relationalOperator, counter);
        scaleUpPolicy = new LoadBalancerTO.AutoScalePolicyTO(scaleUpPolicyId, scaleUpPolicyUiid, scaleUpPolicyDuration,
        ...
        scaleDownPolicy = new LoadBalancerTO.AutoScalePolicyTO(scaleDownPolicyId, scaleUpPolicyUiid, scaleDownPolicyDuration,
    ...
    public void testConditionTO() {
        ...
        Assert.assertEquals(conditionUiid, condition.getUuid());
