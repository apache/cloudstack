...
@JacksonXmlRootElement(localName = "RestorePoints")
public class RestorePoints {
    @JacksonXmlProperty(localName = "RestorePoint")
    @JacksonXmlElementWrapper(localName = "RestorePoint", useWrapping = false)
