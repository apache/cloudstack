...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      details: ['publicip', 'gateway', 'localvtiip', 'peervtiip', 'vtiprefixlength', 'passive', 'cidrlist', 'ipsecpsk', 'ikepolicy', 'esppolicy', 'ikelifetime', 'ikeversion', 'esplifetime', 'dpd', 'splitconnections', 'forceencap', 'created'],
      actions: [
        {
