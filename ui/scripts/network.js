                                        ...
                                        add: {
                                                    ...
                                                    logicalrouteruuid: {
                                                        ...
                                                        select: function(args) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                async: true,
                                                                success: function(json) {
                                                                    var logicalrouters = json.listtungstenfabriclogicalrouterresponse.logicalrouter ? json.listtungstenfabriclogicalrouterresponse.logicalrouter : [];
                                                                    logicalrouters.forEach(function(logicalrouter){
                                                                        items.push({
                                                                            id: logicalrouter.uuid,
                                                                            description: logicalrouter.name
                                                                        })
                                                                    });
                                                                    args.response.success({
                                                                        data: items
                                            ...
                                            action: function(args) {
                                                var dataObj = {
                                                    zoneid: args.context.networks[0].zoneid,
                                                    networkuuid: args.context.networks[0].id,
                                                    logicalrouteruuid: args.data.logicalrouteruuid
                                                };
                                                $.ajax({
                                    ...
                                    detailView: {
                                        ...
                                        actions: {
                                            remove: {
                                                ...
                                                messages: {
                                                    confirm: function (args) {
                                                        return 'message.tungsten.logicalrouter.remove';
                                                    },
                                                    notification: function(args) {
                                                        ...
                                                        add: {
                                                            ...
                                                            createForm: {
                                                                ...
                                                                fields: {
                                                                    ...
                                                                    sequence: {
                                                                        label: 'label.tungsten.firewallpolicy.sequence',
                                                                        defaultValue: '1',
                                                                        validation: {
                                                                            required: true
                                                                        }
                                                            ...
                                                            firewallrule: {
                                                                ...
                                                                listView: {
                                                                    ...
                                                                    fields: {
                                                                        ...
                                                                        srcaddressgroup: {
                                                                            label: 'label.tungsten.srcaddress',
                                                                            converter: function(text, item) {
                                                                                if (typeof item.srctag != 'undefined') {
                                                                                    return item.srctag;
                                                                                } else if (typeof item.srcaddressgroup != 'undefined') {
                                                                                    return item.srcaddressgroup;
                                                                                } else if (typeof item.srcnetwork != 'undefined') {
                                                                                    return item.srcnetwork;
                                                                                } else {
                                                                                    return '';
                                                                                }
                                                                        ...
                                                                        destaddressgroup: {
                                                                            label: 'label.tungsten.destaddress',
                                                                            converter: function(text, item) {
                                                                                if (typeof item.desttag != 'undefined') {
                                                                                    return item.desttag;
                                                                                } else if (typeof item.destaddressgroup != 'undefined') {
                                                                                    return item.destaddressgroup;
                                                                                } else if (typeof item.destnetwork != 'undefined') {
                                                                                    return item.destnetwork;
                                                                                } else {
                                                                                    return '';
                                                                                }
                                                                            }
                                                                    ...
                                                                    actions: {
                                                                        add: {
                                                                            ...
                                                                            action: function(args) {
                                                                                ...
                                                                                if (args.data.srcnetworkuuid != '') {
                                                                                    $.extend(dataObj, {
                                                                                        srcnetworkuuid: args.data.srcnetworkuuid
                                                                                    });
                                                                                }
                                                                                ...
                                                                                if (args.data.destnetworkuuid != '') {
                                                                                    $.extend(dataObj, {
                                                                                        destnetworkuuid: args.data.destnetworkuuid
                                                                                    });
                                                                                }
