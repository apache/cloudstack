...
public class ElastistorPrimaryDataStoreLifeCycle implements PrimaryDataStoreLifeCycle {
    ...
    public boolean attachCluster(DataStore store, ClusterScope scope) {
        ...
        List<HostVO> allHosts = _resourceMgr.listAllUpHostsNotInMaintenance(Host.Type.Routing, primarystore.getClusterId(), primarystore.getPodId(), primarystore.getDataCenterId());
        if (allHosts.isEmpty()) {
