...
public class UpdateNetrisVpcCommandTest {
    ...
    private static final String PREVIOUS_VPC_NAME = "previous-vpc";

    @Test
    public void testConstructorAndGetters() {
        // Act
        UpdateNetrisVpcCommand command = new UpdateNetrisVpcCommand(
    ...
    public void testSettersAndGetters() {
        ...
        // Act
        command.setPreviousVpcName(PREVIOUS_VPC_NAME);

        // Assert
        assertEquals(PREVIOUS_VPC_NAME, command.getPreviousVpcName());
    }
