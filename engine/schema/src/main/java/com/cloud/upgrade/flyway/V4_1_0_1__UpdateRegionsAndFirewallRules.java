...
public class V4_1_0_1__UpdateRegionsAndFirewallRules extends BaseJavaMigration {
    final static Logger s_logger = Logger.getLogger(V4_1_0_1__UpdateRegionsAndFirewallRules.class);
