 ...
 */
        ...
        public  class ResetInstanceAttributeResponseType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ResetInstanceAttributeResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static ResetInstanceAttributeResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ResetInstanceAttributeResponseType object =
                new ResetInstanceAttributeResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ResetInstanceAttributeResponseType".equals(type)){
                                ...
                                return (ResetInstanceAttributeResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
