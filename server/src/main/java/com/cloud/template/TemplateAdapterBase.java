...
public abstract class TemplateAdapterBase extends AdapterBase implements TemplateAdapter {
    ...
    @Override
    public TemplateProfile prepare(boolean isIso, Long userId, String name, String displayText, CPU.CPUArchitecture architecture, Integer bits, Boolean passwordEnabled, Boolean requiresHVM, String url,
        ...
        return prepare(isIso, userId, name, displayText, architecture, bits, passwordEnabled, requiresHVM, url, isPublic, featured, isExtractable, format, guestOSId, zoneId,
    ...
    public TemplateProfile prepare(boolean isIso, long userId, String name, String displayText, CPU.CPUArchitecture architecture, Integer bits, Boolean passwordEnabled, Boolean requiresHVM, String url,
        ...
        return new TemplateProfile(id, userId, name, displayText, architecture, bits, passwordEnabled, requiresHVM, url, isPublic, featured, isExtractable, imgfmt, guestOSId, zoneIdList,
    ...
    public TemplateProfile prepare(RegisterTemplateCmd cmd) throws ResourceAllocationException {
        ...
        return prepare(false, CallContext.current().getCallingUserId(), cmd.getTemplateName(), cmd.getDisplayText(), cmd.getArchitecture(), cmd.getBits(), cmd.isPasswordEnabled(), cmd.getRequiresHvm(),
    ...
    private TemplateProfile prepareUploadParamsInternal(UploadParams params) throws ResourceAllocationException {
        ...
        return prepare(params.isIso(), params.getUserId(), params.getName(), params.getDisplayText(), params.getArchitecture(), params.getBits(),
    ...
    public TemplateProfile prepare(GetUploadParamsForTemplateCmd cmd) throws ResourceAllocationException {
        ...
        UploadParams params = new TemplateUploadParams(CallContext.current().getCallingUserId(), cmd.getName(),
                cmd.getDisplayText(), cmd.getArchitecture(), cmd.getBits(), BooleanUtils.toBoolean(cmd.isPasswordEnabled()),
    ...
    public TemplateProfile prepare(RegisterIsoCmd cmd) throws ResourceAllocationException {
        ...
        return prepare(true, CallContext.current().getCallingUserId(), cmd.getIsoName(), cmd.getDisplayText(), cmd.getArchitecture(), 64, cmd.isPasswordEnabled(), true, cmd.getUrl(), cmd.isPublic(),
