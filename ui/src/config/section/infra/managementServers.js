...
export default {
  ...
  details: ['state', 'laststart', 'laststop', 'version', 'systemmemorytotal', 'systemmemoryfree', 'availableprocessors', 'javadistribution', 'javaversion', 'osdistribution', 'agentcount', 'sessions', 'heapmemoryused', 'heapmemorytotal', 'threadsblockedcount', 'threadsdeamoncount', 'threadsnewcount', 'threadsrunnablecount', 'threadsterminatedcount', 'threadstotalcount', 'threadswaitingcount'],
  tabs: [{
    name: 'details',
