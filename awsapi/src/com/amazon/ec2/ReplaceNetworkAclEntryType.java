 ...
 */
        ...
        public  class ReplaceNetworkAclEntryType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReplaceNetworkAclEntryType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static ReplaceNetworkAclEntryType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReplaceNetworkAclEntryType object =
                new ReplaceNetworkAclEntryType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReplaceNetworkAclEntryType".equals(type)){
                                ...
                                return (ReplaceNetworkAclEntryType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
