...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      details: ['name', 'id', 'displaytext', 'cidr', 'networkdomain', 'ip6routes', 'ispersistent', 'redundantvpcrouter', 'restartrequired', 'zonename', 'account', 'domain', 'publicmtu'],
