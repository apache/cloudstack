...
@APICommand(name = "stopVpcInlineLoadBalancerVM", description = "Stops an VpcInline LB vm.", responseObject = DomainRouterResponse.class,
        since="4.10.0", authorized = {RoleType.Admin})
public class StopVpcInlineLoadBalancerVmCmd extends BaseAsyncCmd {
    public static final Logger s_logger = Logger.getLogger(StopVpcInlineLoadBalancerVmCmd.class.getName());
    private static final String s_name = "stopvpcinlinelbvmresponse";
    ...
    public void execute() throws ConcurrentOperationException, ResourceUnavailableException {
        ...
        if (vm == null || vm.getRole() != Role.LB) {
            ...
            result = _vpcInlineLbVmMgr.stopVpcInlineLbVm(getId(), isForced(), CallContext.current().getCallingAccount(), CallContext.current().getCallingUserId());
        }
