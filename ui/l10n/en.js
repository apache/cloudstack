...
"label.basic":"Basic",
"label.basic.warn.eol":"The Basic network will not be supported on Apache CloudStack 5.0",
"label.basic.warn.eol.intro":"Before proceeding to the next step, be warned that the Basic network will not be supported on Apache CloudStack 5.0. Therefore, this basic installation will create a zone that will not be supported on Apache CloudStack 5.0",
