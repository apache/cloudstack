...
public class LinstorVMSnapshotStrategy extends DefaultVMSnapshotStrategy {
    ...
    public VMSnapshot takeVMSnapshot(VMSnapshot vmSnapshot) {
        ...
        try {
            ...
            List<VolumeObjectTO> volumeTOs = _vmSnapshotHelper.getVolumeTOList(userVm.getId());
    ...
    public boolean deleteVMSnapshot(VMSnapshot vmSnapshot) {
        ...
        for (VolumeObjectTO volumeObjectTO : volumeTOs) {
            ...
            {
                throw new CloudRuntimeException(
                    String.format("Unable to delete Linstor resource %s snapshot %s: %s", rscName, snapshotName, err));
            }
