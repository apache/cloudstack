...
public class ListFilesCommand extends Command {
    ...
    public ListFilesCommand(long volumeId, String filesystem, String dirPath, String backupPath, NfsTO datastore, Boolean isSymlink, Set<String> secondaryStorageUrls) {
