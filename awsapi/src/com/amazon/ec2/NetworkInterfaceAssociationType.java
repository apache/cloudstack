...
/**
*  NetworkInterfaceAssociationType bean class
*/

public class NetworkInterfaceAssociationType implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
            name = NetworkInterfaceAssociationType
    ...
    */
    ...
    protected java.lang.String localIpOwnerId;

    /*  This tracker boolean wil be used to detect whether the user called the set method
    *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localIpOwnerIdTracker = false;
    ...
    */
    public java.lang.String getIpOwnerId() {
        return localIpOwnerId;
    }

    /**
       * Auto generated setter method
       * @param param IpOwnerId
       */
    public void setIpOwnerId(java.lang.String param) {

        if (param != null) {
            //update the setting tracker
            localIpOwnerIdTracker = true;
        } else {
            localIpOwnerIdTracker = false;

        }

        this.localIpOwnerId = param;
    ...
    public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
            ...
            public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                NetworkInterfaceAssociationType.this.serialize(parentQName, factory, xmlWriter);
            }
        };
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":NetworkInterfaceAssociationType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "NetworkInterfaceAssociationType", xmlWriter);
            }
        ...
        if (localIpOwnerIdTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "ipOwnerId", namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);

                } else {
                    xmlWriter.writeStartElement(namespace, "ipOwnerId");
                }

            } else {
                xmlWriter.writeStartElement("ipOwnerId");
            }

            if (localIpOwnerId == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("ipOwnerId cannot be null!!");

            } else {

                xmlWriter.writeCharacters(localIpOwnerId);
    ...
    */
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (localIpOwnerIdTracker) {
            elementList.add(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "ipOwnerId"));

            if (localIpOwnerId != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIpOwnerId));
            } else {
                throw new org.apache.axis2.databinding.ADBException("ipOwnerId cannot be null!!");
            }
        }
    ...
    public static class Factory {
        ...
        */
        public static NetworkInterfaceAssociationType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NetworkInterfaceAssociationType object = new NetworkInterfaceAssociationType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NetworkInterfaceAssociationType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (NetworkInterfaceAssociationType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "ipOwnerId").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setIpOwnerId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
