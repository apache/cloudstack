...
public class StartInstanceBootGroupCmd extends BaseAsyncCmd implements UserCmd {
    ...
    public String getEventType() {
        return EventTypes.EVENT_INSTANCE_BOOT_GROUP_START;
    }
    ...
    public void execute() {
        ...
        try {
            result = instanceBootGroupService.startInstanceBootGroup(this);
        } catch (CloudRuntimeException e) {
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, e.getMessage());
        }
        if (result == null) {
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to start instance boot group");
        }
