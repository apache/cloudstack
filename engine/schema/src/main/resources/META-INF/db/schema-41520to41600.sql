...
CREATE TABLE `cloud`.`dc_ipv6_range` (
  ...
  `router_ipv6` varchar(255) DEFAULT NULL COMMENT 'Outbound IPv6 address on virtual router for this ipv6 range',
  `router_ipv6_gateway` varchar(255) DEFAULT NULL COMMENT 'The gateway of Outbound IPv6 network on virtual router for this ipv6 range',
  `router_ipv6_vlan` varchar(255) DEFAULT NULL COMMENT 'The vlan of Outbound IPv6 network on virtual router for this ipv6 range',
