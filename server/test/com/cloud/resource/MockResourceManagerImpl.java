...
public class MockResourceManagerImpl extends ManagerBase implements ResourceManager {
     ...
     */
    @Override
    public Cluster updateCluster(final Cluster cluster, final String clusterType, final String hypervisor, final String allocationState, final String managedstate, Map<String, String> physicalNetworkTrafficLabels) {
        // TODO Auto-generated method stub
        return null;
    }
