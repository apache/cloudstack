...
public class CreateVMScheduleCmdTest {
    ...
    private CreateVMScheduleCmd createVMScheduleCmd;

    @Before
    public void setUp() throws Exception {
        MockitoAnnotations.initMocks(this);
        createVMScheduleCmd = new CreateVMScheduleCmd();
        createVMScheduleCmd.vmScheduleManager = vmScheduleManager;
        createVMScheduleCmd._entityMgr = entityManager;
    }
