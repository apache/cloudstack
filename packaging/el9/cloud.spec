...
cp packaging/el9/replace.properties build/replace.properties
...
cp packaging/el9/cloudstack-sccs ${RPM_BUILD_ROOT}/usr/bin
...
install -D packaging/el9/cloud-ipallocator.rc ${RPM_BUILD_ROOT}%{_initrddir}/%{name}-ipallocator
install -D packaging/el9/cloud.limits ${RPM_BUILD_ROOT}%{_sysconfdir}/security/limits.d/cloud
...
%changelog
* Sun Oct 23 2022 Rohit Yadav <rohit@apache.org> 4.18.0
- Add EL9 packaging support
