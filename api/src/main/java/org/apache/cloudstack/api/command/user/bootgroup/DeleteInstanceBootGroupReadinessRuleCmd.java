...
public class DeleteInstanceBootGroupReadinessRuleCmd extends BaseCmd implements UserCmd {
    ...
    @Override
    public void execute() {
        boolean result = instanceBootGroupService.deleteInstanceBootGroupReadinessRule(this);
        if (!result) {
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to delete instance boot group readiness rule");
        }
