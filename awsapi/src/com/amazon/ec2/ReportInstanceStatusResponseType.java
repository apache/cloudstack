 ...
 */
        ...
        public  class ReportInstanceStatusResponseType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReportInstanceStatusResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static ReportInstanceStatusResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReportInstanceStatusResponseType object =
                new ReportInstanceStatusResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReportInstanceStatusResponseType".equals(type)){
                                ...
                                return (ReportInstanceStatusResponseType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
