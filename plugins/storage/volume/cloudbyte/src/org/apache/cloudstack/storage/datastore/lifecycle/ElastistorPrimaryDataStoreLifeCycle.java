...
public class ElastistorPrimaryDataStoreLifeCycle implements PrimaryDataStoreLifeCycle {
    ...
    public DataStore initialize(Map<String, Object> dsInfos) {
        ...
        // int storagePort =
        // Integer.parseInt(details.get(ElastistorUtil.ES_STORAGE_PORT));
        ...
        // String uuid = ElastistorUtil.ES_PROVIDER_NAME + "_" + zone.getUuid()
        // + "_" + storageIp;

        String uuid = ElastistorUtil.ES_PROVIDER_NAME + "_" + zone.getUuid()
                + "_" + storageIp + "_" + accesspath;

        if (capacityBytes == null || capacityBytes <= 0) {
            throw new IllegalArgumentException(
                    "'capacityBytes' must be present and greater than 0.");
        }

        if (capacityIops == null || capacityIops <= 0) {
            throw new IllegalArgumentException(
                    "'capacityIops' must be present and greater than 0.");
        }
        ...
        try {
            ...
            e.printStackTrace();
            throw new IllegalArgumentException(
                    "ELASTICENTER CONNECTION FAILED", e);
        ...
        try {
            ...
            if (null != esaccountid)
                cmd.putCommandParameter(ElastistorUtil.REST_PARAM_ACCOUNTID,
                        esaccountid);
            if (null != totalthroughput)
                cmd.putCommandParameter("totalthroughput", totalthroughput);
            if (null != espoolid)
                cmd.putCommandParameter(ElastistorUtil.REST_PARAM_POOLID,
                        espoolid);
            if (null != storagePoolName)
                cmd.putCommandParameter("name", "TSM" + storagePoolName);
            if (null != quotasize)
                cmd.putCommandParameter("quotasize", quotasize);

            if (null != storageIp) {
                cmd.putCommandParameter("ipaddress", storageIp);
            }
            if (null != essubnet) {
                cmd.putCommandParameter(ElastistorUtil.REST_PARAM_SUBNET,
                        essubnet);
            }
            if (null != esdefaultgateway)
                cmd.putCommandParameter(ElastistorUtil.REST_PARAM_GATEWAY,
                        esdefaultgateway);
            if (null != estntinterface)
                cmd.putCommandParameter(ElastistorUtil.REST_PARAM_INTERFACE,
                        estntinterface);
            if (null != noofcopies)
                cmd.putCommandParameter("noofcopies", noofcopies);
            if (null != blocksize)
                cmd.putCommandParameter("recordsize", blocksize);
            if (null != totaliops)
                cmd.putCommandParameter("totaliops", totaliops);
            if (null != latency)
                cmd.putCommandParameter("latency", latency);
            if (null != blocksize)
                cmd.putCommandParameter("blocksize", blocksize);

            if (null != graceallowed)
                cmd.putCommandParameter("graceallowed", graceallowed);

            CreateTsmCmdResponse cmdResponse = (CreateTsmCmdResponse) restClient
                    .executeCommand(cmd);
            ...
            if (cmdResponse.getTsm().getUuid() == null) {
                ...
                throw new CloudRuntimeException(
                        "TSM CREATION FAILED , contact elatistor admin");
            }
            /*
             * else{ AddQosGroupCmd cmd2 = new AddQosGroupCmd();
             *
             * tsmid = cmdResponse.getTsm().getUuid(); datasetid =
             * cmdResponse.getTsm().getDatasetid();
             *
             * if ( null != storagePoolName ) cmd2.putCommandParameter("name",
             * "QOS_"+storagePoolName); if ( null != totaliops )
             * cmd2.putCommandParameter("iops", totaliops); if ( null != latency
             * ) cmd2.putCommandParameter("latency", latency); if ( null !=
             * blocksize ) cmd2.putCommandParameter("blocksize", blocksize); if
             * ( null != totalthroughput )
             * cmd2.putCommandParameter("throughput", totalthroughput); if (
             * null != memlimit ) cmd2.putCommandParameter("memlimit",
             * memlimit); if ( null != networkspeed )
             * cmd2.putCommandParameter("networkspeed", networkspeed); if ( null
             * != tsmid ) cmd2.putCommandParameter("tsmid", tsmid); if ( null !=
             * datasetid ) cmd2.putCommandParameter("datasetid", datasetid); if
             * ( null != graceallowed ) cmd2.putCommandParameter("graceallowed",
             * graceallowed);
             *
             * AddQosGroupCmdResponse cmdResponse2 = (AddQosGroupCmdResponse)
             * restClient.executeCommand( cmd2 );
             *
             * if ( cmdResponse2.getQoSGroup().getUuid() == null ) {
             *
             * s_logger.error(
             * "*************ADD QOS GROUP FAILED *********************"); throw
             ...
             * esaccountid); if ( null != qosgroupid )
             * cmd3.putCommandParameter("qosgroupid", qosgroupid); if ( null !=
             * tsmid ) cmd3.putCommandParameter("tsmid", tsmid); if ( null !=
             * espoolid )
             * cmd3.putCommandParameter(ElastistorUtil.REST_PARAM_POOLID,
             * espoolid); if ( null != storagePoolName )
             * cmd3.putCommandParameter("name", storagePoolName); if ( null !=
             * quotasize ) cmd3.putCommandParameter("quotasize", quotasize); if
             * ( null != blocksize ) cmd3.putCommandParameter("blocksize",
             * blocksize); if ( null != deduplication )
             * cmd3.putCommandParameter("deduplication", deduplication); if (
             * null != sync ) cmd3.putCommandParameter("sync", sync); if ( null
             * != compression ) cmd3.putCommandParameter("compression",
             * compression); if ( null != noofcopies )
             * cmd3.putCommandParameter("noofcopies", noofcopies);
             * cmd3.putCommandParameter("mountpoint", mountpoint); if ( null !=
             * casesensitivity ) cmd3.putCommandParameter("casesensitivity",
             * casesensitivity); if ( null != readonly )
             * cmd3.putCommandParameter("readonly", readonly); if ( null !=
             * datasetid ) cmd3.putCommandParameter("datasetid", datasetid); if
             * ( null != unicode ) cmd3.putCommandParameter("unicode", unicode);
             * cmd3.putCommandParameter("protocoltype", protocoltype); if ( null
             * != authnetwork ) cmd3.putCommandParameter("authnetwork",
             * authnetwork); if ( null != mapuserstoroot )
             * cmd3.putCommandParameter("mapuserstoroot", mapuserstoroot);
             *
             *
             * CreateVolumeCmdResponse cmdResponse3 = (CreateVolumeCmdResponse)
             * restClient.executeCommand( cmd3 );
             *
             *
             ...
             *
             * } else { s_logger.info("creation of elastistor volume complete");
             * }
             *
             *
             * if(protocoltype == "iscsi") { accesspath =
             * "/"+cmdResponse3.getFileSystem().getIqn()+"/0";
             *
             * }
             *
             * } }
    ...
    /*
     * @Override public boolean attachCluster(DataStore store, ClusterScope
     * scope) { _dataStoreHelper.attachCluster(store); return true; }
     */
    ...
    public boolean attachCluster(DataStore store, ClusterScope scope) {
         ...
         * Check if there is host up in this cluster List<HostVO> allHosts =
         * _resourceMgr.listAllUpAndEnabledHosts(Host.Type.Routing,
         * primarystore.getClusterId(), primarystore.getPodId(),
         * primarystore.getDataCenterId()); if (allHosts.isEmpty()) {
         * primaryDataStoreDao.expunge(primarystore.getId()); throw new
         * CloudRuntimeException
         * ("No host up to associate a storage pool with in cluster " +
         * primarystore.getClusterId()); }
         */
        /*
         * boolean success = false; for (HostVO h : allHosts) { success =
         * createStoragePool(h.getId(), primarystore); if (success) { break; } }
         */
        /*
         * s_logger.debug("In createPool Adding the pool to each of the hosts");
         * List<HostVO> poolHosts = new ArrayList<HostVO>(); for (HostVO h :
         * allHosts) { try { storageMgr.connectHostToSharedPool(h.getId(),
         * primarystore.getId()); // poolHosts.add(h); } catch (Exception e) {
         ...
         * primaryDataStoreDao.expunge(primarystore.getId()); throw new
         * CloudRuntimeException("Failed to access storage pool"); }
         */
    ...
    public boolean attachZone(DataStore dataStore, ZoneScope scope,
        ...
        List<HostVO> xenServerHosts = _resourceMgr
                .listAllUpAndEnabledHostsInOneZoneByHypervisor(
                        HypervisorType.XenServer, scope.getScopeId());
        List<HostVO> vmWareServerHosts = _resourceMgr
                .listAllUpAndEnabledHostsInOneZoneByHypervisor(
                        HypervisorType.VMware, scope.getScopeId());
        List<HostVO> kvmHosts = _resourceMgr
                .listAllUpAndEnabledHostsInOneZoneByHypervisor(
                        HypervisorType.KVM, scope.getScopeId());
    ...
    public boolean deleteDataStore(DataStore store) {
        List<StoragePoolHostVO> hostPoolRecords = _storagePoolHostDao
        ...
        for (StoragePoolHostVO host : hostPoolRecords) {
            DeleteStoragePoolCommand deleteCmd = new DeleteStoragePoolCommand(
                    pool);
            final Answer answer = agentMgr
                    .easySend(host.getHostId(), deleteCmd);
        ...
        /*
         * if (!deleteFlag) { throw new
         * CloudRuntimeException("Failed to delete storage pool on host"); }
         */
        ...
        try {
            ...
            boolean status = ElastistorUtil.deleteElastistorVolume(poolip,
                    esip, apikey);
            ...
            e.printStackTrace();
            throw new CloudRuntimeException(
                    "Failed to delete storage pool on ELASTISTOR, now clearing the DB");
        }
