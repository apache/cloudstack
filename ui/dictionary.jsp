...
'error.could.not.change.your.password.because.non.native.user': '<fmt:message key="error.could.not.change.your.password.because.non.native.user" />',
...
'label.direct.download': '<fmt:message key="label.direct.download" />',
...
'label.ha.configure': '<fmt:message key="label.ha.configure" />',
'label.ha.disable': '<fmt:message key="label.ha.disable" />',
'label.ha.enable': '<fmt:message key="label.ha.enable" />',
'label.ha.provider': '<fmt:message key="label.ha.provider" />',
'label.ha.state': '<fmt:message key="label.ha.state" />',
'label.ha': '<fmt:message key="label.ha" />',
