...
function generateRouterMap (section) {
  var map = {
    ...
    meta: { title: section.title, icon: section.icon, shortKey: section.shortKey, docHelp: Vue.prototype.$applyDocHelpMappings(section.docHelp), searchFilters: section.searchFilters },
    component: RouteView
  }
