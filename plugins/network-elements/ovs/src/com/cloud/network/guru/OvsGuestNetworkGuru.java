...
public class OvsGuestNetworkGuru extends GuestNetworkGuru {
    ...
    protected void allocateVnet(Network network, NetworkVO implemented, long dcId,
        ...
        if (network.getBroadcastUri() == null) {
            ...
            ActionEventUtils.onCompletedActionEvent(UserContext.current().getCallingUserId(), network.getAccountId(), EventVO.LEVEL_INFO, EventTypes.EVENT_ZONE_VLAN_ASSIGN, "Assigned Zone Vlan: " + vnet + " Network Id: " + network.getId(), 0);
        } else {
