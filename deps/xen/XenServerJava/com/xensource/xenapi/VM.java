...
public class VM extends XenAPIObject {
    ...
    /**
     * Set the memory limits of the given VM.
     *
     * @param set staticMin staticMax dynamicMin dynamicMax 
     */
    public void setMemoryLimits(Connection c, Long staticMin, Long staticMax, Long dynamicMin,  Long dynamicMax) throws
       ...
       XmlRpcException {
        ...
        String session = c.getSessionReference();
        Object[] method_params = {Marshalling.toXMLRPC(session), Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(staticMin),
                Marshalling.toXMLRPC(staticMax), Marshalling.toXMLRPC(dynamicMin), Marshalling.toXMLRPC(dynamicMax)};
        Map response = c.dispatch(method_call, method_params);
        return;
    }
