...
@APICommand(name = ListTungstenFabricNetworkRouteTableCmd.APINAME, description = "list Tungsten-Fabric route table",
        responseObject = TungstenFabricNetworkRouteTableResponse.class, requestHasSensitiveInfo = false, responseHasSensitiveInfo =
        false)
public class ListTungstenFabricNetworkRouteTableCmd extends BaseListCmd {
