                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LicenseSetItemType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "LicenseSetItemType",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localCapacitySet.serialize(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/","capacitySet"),
                                               factory,xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static LicenseSetItemType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LicenseSetItemType object =
                new LicenseSetItemType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LicenseSetItemType".equals(type)){
                                ...
                                return (LicenseSetItemType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
