...
@APICommand(name = "cutoverVmwareCbtMigration",
...
public class CutoverVmwareCbtMigrationCmd extends BaseAsyncCmd {
    ...
    public String getEventType() {
        return EventTypes.EVENT_VMWARE_CBT_MIGRATION_CUTOVER;
    }

    @Override
    public String getEventDescription() {
        return String.format("Cutting over VMware CBT migration: %s", id);
    }
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        VmwareCbtMigrationResponse response = vmwareCbtMigrationManager.cutoverVmwareCbtMigration(this);
