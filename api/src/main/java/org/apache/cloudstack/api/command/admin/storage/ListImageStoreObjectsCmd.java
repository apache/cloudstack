...
import org.apache.cloudstack.storage.browser.ImageStoreObjectResponse;
...
@APICommand(name = "listImageStoreObjects", description = "Lists objects at specified path on image stores.",
            responseObject = ImageStoreObjectResponse.class,
            since = "4.19.0",
...
public class ListImageStoreObjectsCmd extends BaseListCmd {
    ...
    @Override
    public void execute() {
        ListResponse<ImageStoreObjectResponse> response = storageBrowser.listImageStore(this);
