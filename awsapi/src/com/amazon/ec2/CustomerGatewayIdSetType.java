...
public class CustomerGatewayIdSetType implements org.apache.axis2.databinding.ADBBean {
    ...
    */
    public void addItem(com.amazon.ec2.CustomerGatewayIdSetItemType param) {
        ...
        list.add(param);
        this.localItem = (com.amazon.ec2.CustomerGatewayIdSetItemType[])list.toArray(new com.amazon.ec2.CustomerGatewayIdSetItemType[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":CustomerGatewayIdSetType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CustomerGatewayIdSetType", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        */
        public static CustomerGatewayIdSetType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CustomerGatewayIdSetType object = new CustomerGatewayIdSetType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CustomerGatewayIdSetType".equals(type)) {
                            ...
                            return (CustomerGatewayIdSetType)com.amazon.ec2.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2012-08-15/", "item").equals(reader.getName())) {
                    ...
                    object.setItem((com.amazon.ec2.CustomerGatewayIdSetItemType[])org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                        com.amazon.ec2.CustomerGatewayIdSetItemType.class, list1));
