...
public class AddTungstenFirewallRuleCommand extends TungstenCommand {
    private final String firewallPolicyUuid;
    private final String firewallRuleUuid;
    private final int sequence;

    public AddTungstenFirewallRuleCommand(final String firewallPolicyUuid, final String firewallRuleUuid,
        final int sequence) {
